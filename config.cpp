...
class CfgMods
{
	class DZ_Expansion
	{
		...
		expansionSkins[]=
		{
			"DayZExpansion/Skins/Weapons/",
			"DayZExpansion/Skins/Magazines/",
			"DayZExpansion/Skins/Vehicles/General/",
			"DayZExpansion/Skins/Vehicles/OffroadHatchback/",
			"DayZExpansion/Skins/Vehicles/Hatchback_02/",
			"DayZExpansion/Skins/Vehicles/Sedan_02/"
		};
