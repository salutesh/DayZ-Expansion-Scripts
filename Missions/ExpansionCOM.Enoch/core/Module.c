...
class COM_Module
{
	...
	protected ref set< ref COM_KeyMouseBinding > m_KeyBindings;
	
	void COM_Module()
	{
		m_Enabled = true;
		m_PreventInput = false;
		m_KeyBindings = new set< ref COM_KeyMouseBinding >;
	}
	...
	void RegisterCOM_KeyMouseBindings() 
	{
	}
	
	void RegisterCOM_KeyMouseBinding( COM_KeyMouseBinding binding ) 
	{
	...
	set< ref COM_KeyMouseBinding > GetBindings()
	{
