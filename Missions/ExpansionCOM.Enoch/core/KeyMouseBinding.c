class COM_KeyMouseBinding
{
	...
	void COM_KeyMouseBinding( typename object, string callback, string description, bool menu = false ) 
	{
		m_Object = object;
		...
		m_ActionType = COM_KeyMouseActionType.PRESS;
	}
