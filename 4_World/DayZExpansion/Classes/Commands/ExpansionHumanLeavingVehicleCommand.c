/**
 * ExpansionHumanLeavingVehicleCommand.c
 *
 * DayZ Expansion Mod
...
class ExpansionHumanLeavingVehicleCommand_ST
{
	int m_VehicleType;
	...
	void ExpansionHumanLeavingVehicleCommand_ST( Human human )
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionHumanLeavingVehicleCommand_ST::ExpansionHumanLeavingVehicleCommand_ST Start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionHumanLeavingVehicleCommand_ST::ExpansionHumanLeavingVehicleCommand_ST End");
		#endif
	}
}

class ExpansionHumanLeavingVehicleCommand extends HumanCommandScript
{
	PlayerBase m_Player;
	ExpansionHumanLeavingVehicleCommand_ST m_Table;
	...
	void ExpansionHumanLeavingVehicleCommand( PlayerBase player, Object veh, ExpansionHumanLeavingVehicleCommand_ST table )
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionHumanLeavingVehicleCommand::ExpansionHumanLeavingVehicleCommand Start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionHumanLeavingVehicleCommand::ExpansionHumanLeavingVehicleCommand End");
		#endif
	}
