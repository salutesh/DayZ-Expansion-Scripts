/**
 * ActionFeedAntibioticsTablets.c.c
 *
 * DayZ Expansion Mod
...
modded class ActionFeedTetracyclineAntibiotics
{
	...
	void ActionFeedTetracyclineAntibiotics()
	{
    ...
    override void ApplyModifiers( ActionData action_data )
	{
		...
		{
			m_HumanityModule.OnFeedTetracyclineAntibioticsActionEvent( action_data.m_Player, action_data.m_Target.GetObject() );
		}
