		...
		class defs
		{
			class engineScriptModule
			{
				files[]=
				{
					...
					"DayZExpansion/0_Missions_Preload/Common",
					"DayZExpansion/0_Missions_Preload/1_Core"
				};
			};
			class gameLibScriptModule
			{
				files[]=
				{
					...
					"DayZExpansion/0_Missions_Preload/Common",
					"DayZExpansion/0_Missions_Preload/2_GameLib"
				};
			};
			class gameScriptModule
			{
				files[]=
				{
					...
					"DayZExpansion/0_Missions_Preload/Common",
					"DayZExpansion/0_Missions_Preload/3_Game"
				};
			};
			class worldScriptModule
			{
				files[]=
				{
					...
					"DayZExpansion/0_Missions_Preload/Common",
					"DayZExpansion/0_Missions_Preload/4_World"
				};
			};
			class missionScriptModule
			{
				files[]=
				{
					...
					"DayZExpansion/0_Missions_Preload/Common",
					"DayZExpansion/0_Missions_Preload/5_Mission"
				};
			};
		};
	};
