	...
	class DZ_Expansion_Chat
	{
		...
		class defs
		{
			...
			class engineScriptModule
			{
				...
				files[]=
				{
					"DayZExpansion/Chat/Scripts/Common",
					"DayZExpansion/Chat/Scripts/1_Core"
				};
			};
			class gameLibScriptModule
			{
				...
				{
					"DayZExpansion/Chat/Scripts/Common",
					"DayZExpansion/Chat/Scripts/2_GameLib"
				};
			};
			class gameScriptModule
			{
				...
				{
					"DayZExpansion/Chat/Scripts/Common",
					"DayZExpansion/Chat/Scripts/3_Game"
				};
			};
			class worldScriptModule
			{
				...
				{
					"DayZExpansion/Chat/Scripts/Common",
					"DayZExpansion/Chat/Scripts/4_World"
				};
			};
			class missionScriptModule
			{
				...
				{
					"DayZExpansion/Chat/Scripts/Common",
					"DayZExpansion/Chat/Scripts/5_Mission"
				};
			};
		};
	};
