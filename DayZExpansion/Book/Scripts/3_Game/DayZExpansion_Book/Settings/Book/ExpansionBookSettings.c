...
class ExpansionBookSettings: ExpansionBookSettingsBase
{
	...
	void DefaultCraftingCategories()
	{
		...
		//category.AddResult("BarrelHoles_");
		...
		//category = new ExpansionBookCraftingCategory("Vehicle Parts");
		//category.AddResult("Truck_01_Wheel");
		//category.AddResult("Truck_01_WheelDouble");
		//CraftingCategories.Insert(category);

		//category = new ExpansionBookCraftingCategory("Vests");
		//category.AddResult("PlateCarrierComplete");
		//CraftingCategories.Insert(category);
		...
		//! Add empty category which will receive all recipes not in other categories
