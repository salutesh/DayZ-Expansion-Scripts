	...
	class DZ_Expansion_PlayerList
	{
		...
		class defs
		{
			...
			class engineScriptModule
			{
				...
				files[]=
				{
					"DayZExpansion/PlayerList/Scripts/Common",
					"DayZExpansion/PlayerList/Scripts/1_Core"
				};
			};
			class gameLibScriptModule
			{
				...
				{
					"DayZExpansion/PlayerList/Scripts/Common",
					"DayZExpansion/PlayerList/Scripts/2_GameLib"
				};
			};
			class gameScriptModule
			{
				...
				{
					"DayZExpansion/PlayerList/Scripts/Common",
					"DayZExpansion/PlayerList/Scripts/3_Game"
				};
			};
			class worldScriptModule
			{
				...
				{
					"DayZExpansion/PlayerList/Scripts/Common",
					"DayZExpansion/PlayerList/Scripts/4_World"
				};
			};
			class missionScriptModule
			{
				...
				{
					"DayZExpansion/PlayerList/Scripts/Common",
					"DayZExpansion/PlayerList/Scripts/5_Mission"
				};
			};
		};
	};
