...
/**@class		ExpansionCraftLumber_0_5
 * @brief		
 **/
class ExpansionCraftLumber_0_5 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_USRACT_CRAFT_LUMBER_05";
		...
		//! Result
		AddResult( "ExpansionLumber0_5" ); //! Add results here
		AddResult( "ExpansionLumber0_5" ); //! Add results here
		AddResult( "ExpansionLumber0_5" ); //! Add results here
		AddResult( "ExpansionLumber0_5" ); //! Add results here
		AddResult( "ExpansionLumber0_5" ); //! Add results here
