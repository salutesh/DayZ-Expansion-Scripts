/**
 * ExpansionCraftExpansionHelipadKit.c
 *
 * DayZ Expansion Mod
...
class ExpansionCraftExpansionHelipadKit: RecipeBase
{
	override void Init()
	{
		m_Name = "#STR_USRACT_CRAFT_HELIPAD_KIT";
		...
		//! Ingredient 1
		InsertIngredient(0, "ExpansionSpraycanBase"); //! You can insert multiple ingredients this way
