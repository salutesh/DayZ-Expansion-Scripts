/**
 * ExpansionCraftExpansionHescoKit.c
 *
 * DayZ Expansion Mod
...
class ExpansionCraftExpansionHescoKit: RecipeBase
{
	override void Init()
	{
		m_Name = "#STR_USRACT_CRAFT_HESCO_KIT";
		...
		//! Ingredient 1
		InsertIngredient(0, "HescoBox"); //! You can insert multiple ingredients this way
		...
		//! Ingredient 2
		InsertIngredient(1, "HescoBox"); //! You can insert multiple ingredients this way
		...
		//! Result
		AddResult("ExpansionHescoKit"); //! Add results here
