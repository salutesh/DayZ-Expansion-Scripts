...
#ifdef JM_COT
class ExpansionCOTTerritoriesListEntry: ScriptedWidgetEventHandler
{
	...
	{
		m_Root					= g_Game.GetWorkspace().CreateWidgets( "DayZExpansion/BaseBuilding/GUI/layouts/COT/territories/Territories_List_Entry_New.layout", parent );
