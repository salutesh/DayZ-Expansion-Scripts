...
#ifdef JM_COT
class ExpansionCOTTerritoriesObjectsListEntry: ScriptedWidgetEventHandler
{
	...
	// ------------------------------------------------------------
	void ExpansionCOTTerritoriesObjectsListEntry(Widget parent, ExpansionCOTTerritoriesMenu menu, ExpansionEntityMetaData object)
	{
		...
		m_Root					= Widget.Cast( g_Game.GetWorkspace().CreateWidgets( "DayZExpansion/BaseBuilding/GUI/layouts/COT/territories/Territories_ObjectList_Entry_New.layout", parent ) );
