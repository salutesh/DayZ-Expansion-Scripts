...
#ifdef JM_COT
class ExpansionCOTTerritoriesMemberListEntry: ScriptedWidgetEventHandler
{
	...
	void ExpansionCOTTerritoriesMemberListEntry(Widget parent, ExpansionCOTTerritoriesMenu menu, ExpansionTerritoryMember member)
	{
		...
		m_Root					= Widget.Cast( g_Game.GetWorkspace().CreateWidgets( "DayZExpansion/BaseBuilding/GUI/layouts/COT/territories/Territories_MemberList_Entry_New.layout", parent ) );
