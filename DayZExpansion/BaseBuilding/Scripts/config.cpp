...
class CfgMods
{
	class DZ_Expansion_BaseBuilding
	{
		...
		class defs
		{
			...
			{
				value = "";
				files[] = {"DayZExpansion/BaseBuilding/Scripts/Common","DayZExpansion/BaseBuilding/Scripts/1_Core"};
			};
			class gameLibScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/BaseBuilding/Scripts/Common","DayZExpansion/BaseBuilding/Scripts/2_GameLib"};
			};
			class gameScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/BaseBuilding/Scripts/Common","DayZExpansion/BaseBuilding/Scripts/3_Game"};
			};
			class worldScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/BaseBuilding/Scripts/Common","DayZExpansion/BaseBuilding/Scripts/4_World"};
			};
			class missionScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/BaseBuilding/Scripts/Common","DayZExpansion/BaseBuilding/Scripts/5_Mission"};
			};
		};
	};
};
