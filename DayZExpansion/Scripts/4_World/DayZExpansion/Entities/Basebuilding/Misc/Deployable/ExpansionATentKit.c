...
/**@class		ExpansionATentKit
 * @brief		This class handle base class of expansion basebuilding	
 **/
class ExpansionATentKit: ExpansionKitLarge
{
	// ------------------------------------------------------------
	// OnPlacementComplete
	// ------------------------------------------------------------
	override void OnPlacementComplete( Man player )
	{
		if ( IsMissionHost() )
		{
			...
			ExpansionATent tent = ExpansionATent.Cast( GetGame().CreateObject( "ExpansionATent", GetPosition() ) );
