/**
 * bldr_expansion_Gyrocopter_Base.c
 *
 * DayZ Expansion Mod
...
class bldr_expansion_Gyrocopter_Base extends House
{
	float m_RotorAnimationPosition;

	// ------------------------------------------------------------
	// bldr_expansion_Gyrocopter_Base Constructor
	// ------------------------------------------------------------
	void bldr_expansion_Gyrocopter_Base()
	{
		SetEventMask( EntityEvent.CONTACT | EntityEvent.SIMULATE );
	}
    
	// ------------------------------------------------------------
	// bldr_expansion_Gyrocopter_Base EOnSimulate
	// ------------------------------------------------------------
