class ExpansionActionCloseVehicleDoor: ActionInteractBase
{
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		{
			vehicle = ExpansionVehicleScript.Cast( action_data.m_Player.GetCommand_ExpansionVehicle().GetTransport() );
		} else
		{
			vehicle = ExpansionVehicleScript.Cast( action_data.m_Target.GetParent() );
		}
