...
/**@class		ExpansionCraftLumber_1
 * @brief		
 **/
class ExpansionCraftLumber_1 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_USRACT_CRAFT_LUMBER_1";
		...
		//! Result
		AddResult( "ExpansionLumber1" ); //! Add results here
		AddResult( "ExpansionLumber1" ); //! Add results here
		AddResult( "ExpansionLumber1" ); //! Add results here
