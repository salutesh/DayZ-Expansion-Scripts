...
/**@class		ExpansionCraftFlagKit
 * @brief		
 **/
class ExpansionCraftFlagKit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_USRACT_CRAFT_FLAG_KIT";
		...
		//! Result
		AddResult("ExpansionFlagKitExpansion"); //! Add results here
