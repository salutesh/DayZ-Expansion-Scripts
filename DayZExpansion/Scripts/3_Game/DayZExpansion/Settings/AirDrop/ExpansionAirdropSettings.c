...
class ExpansionAirdropSettings: ExpansionSettingBase
{
	...
	void DefaultRegular()
	{
		...
		Loot = {
			...
			new ExpansionAirdropLoot( "SKS", sks_1, 0.5, sksVariants ),

			new ExpansionAirdropLoot( "UMP45", ump_1, 0.25, umpVariants ),
 
			new ExpansionAirdropLoot( "Mosin9130", mosin_1, 0.4, mosinVariants ),
 
			new ExpansionAirdropLoot( "B95", b95_1, 0.3, b95Variants ),

			new ExpansionAirdropLoot( "CZ527", cz527_1, 0.5, cz527Variants ),

			new ExpansionAirdropLoot( "CZ75", cz75_1, 0.2, cz75Variants ),

			new ExpansionAirdropLoot( "FNX45", fnx1_1, 0.4, fnxVariants ),

			new ExpansionAirdropLoot( "Expansion_Kedr", kedr_1, 0.5, kedrVariants ),

   			new ExpansionAirdropLoot( "Mp133Shotgun", NULL, 0.8 ),

			new ExpansionAirdropLoot( "Winchester70", winchester70_1, 0.5, winchester70Variants ),
			...
			new ExpansionAirdropLoot( "FirstAidKit", firstaidkit_1 , 0.38, firstaidkitVariants ),
		};
	...
	void DefaultMedical()
	{
		...
		Loot = {
			...
			new ExpansionAirdropLoot( "MedicalScrubsHat_Blue", NULL , 0.24, medicalScrubsHatsVariants ),
			new ExpansionAirdropLoot( "MedicalScrubsPants_Blue", NULL , 0.24, medicalScrubsPantsVariants ),
			new ExpansionAirdropLoot( "MedicalScrubsShirt_Blue", NULL , 0.24, medicalScrubsShirtsVariants ),

			new ExpansionAirdropLoot( "NioshFaceMask", NULL , 0.08),

			new ExpansionAirdropLoot( "SurgicalGloves_Blue", NULL , 0.24, surgicalGlovesVariants ),

			new ExpansionAirdropLoot( "FirstAidKit", firstaidkit_1 , 2.44, firstaidkitVariants ),
		};
	...
	void DefaultMilitary()
	{
		...
		Loot = {
			...
			new ExpansionAirdropLoot( "AK74", ak74_1 , 0.495, ak74Variants ),

			new ExpansionAirdropLoot( "AKS74U", ak74u_1 , 0.55, ak74uVariants ),
			
			new ExpansionAirdropLoot( "AKM", akm_1 , 1.3, akmVariants ),

			new ExpansionAirdropLoot( "Expansion_M16", m16_1 , 0.45, m16Variants ),

			new ExpansionAirdropLoot( "M4A1", m4a1_1 , 0.59, m4a1Variants ),

			new ExpansionAirdropLoot( "FAL", fal_1 , 0.24, falVariants ),

			new ExpansionAirdropLoot( "SVD", svd_1 , 0.28, svdVariants ),

			new ExpansionAirdropLoot( "Saiga", saiga_1 , 0.22, saigaVariants ),
