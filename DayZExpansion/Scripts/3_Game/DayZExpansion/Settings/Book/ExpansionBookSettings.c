...
class ExpansionBookSettings: ExpansionSettingBase
{
	...
	string ItemRequired;
	int ItemRequiredLocation; // 0 = Inventory, 1 = Hand
	...
	{
		RuleCategories = new array< ref ExpansionRulesCategory >;
	}
	...
	private void CopyInternal( ref ExpansionBookSettings s )
	{
		...
		ItemRequired = s.ItemRequired;
		ItemRequiredLocation = s.ItemRequiredLocation;
	}
	...
	{		
		...
		CreateRule("Glitching into bases is a ban reason and will not be tolerated.");
		CreateRule("Glitching under the map or clipping thrue objects will not be tolerated.");
