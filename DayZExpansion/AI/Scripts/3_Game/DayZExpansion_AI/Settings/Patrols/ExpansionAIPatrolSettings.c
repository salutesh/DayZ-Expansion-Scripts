...
class ExpansionAIPatrolSettings: ExpansionSettingBase
{
    ...
    void DefaultCrashPatrols(string worldName)
    {
        ...
        {
            case "chernarusplus":
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "West", "", true, false, 1.0, -2, -2, "Wreck_UH1Y"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "", true, false, 1.0, -2, -2, "Wreck_Mi8_Crashed"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban1_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban2_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Static"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Dynamic"));
            break;
            case "enoch":
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "West", "", true, false, 1.0, -2, -2, "Wreck_UH1Y"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "", true, false, 1.0, -2, -2, "Wreck_Mi8_Crashed"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban1_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban2_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Static"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Dynamic"));
            break;
			case "deerisle":
            ...
            default:
                ...
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "ALTERNATE", "West", "", true, false, 1.0, -2, -2, "Wreck_UH1Y"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "ALTERNATE", "East", "", true, false, 1.0, -2, -2, "Wreck_Mi8_Crashed"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban1_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban2_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban1_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban2_police"));
                return;
            break;
	    }
    ...
    void DefaultPatrols(string worldName)
    {
        switch (worldName)
        {
            case "banov":
                ...
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"1226.16 234.056 4521.42", "978.184 229.308 4361.1"}));
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"640.75 250.928 3287.15", "479.013 252.843 3354.61"}));
            ...
            case "chernarusplus":
                ...
                Patrol.Insert( new ExpansionAIPatrol(4,	"WALK", "SPRINT",     "ALTERNATE",     "Civilian",     "", true, false, 1.0, -2, -2, -2, -100,  	{"7841.334961 76.696114 105.506462", "7874.433594 86.500465 194.182739", "7881.091797 88.818947 247.873428", "7804.406250 88.379280 365.877625", "7792.430176 88.650299 383.001404", "7762.807617 83.737671 334.874634", "7760.653809 84.683838 353.211792", "7768.957031 88.445908 421.012054", "7781.338867 89.113235 430.440430", "7769.263672 90.858253 472.488281", "7776.356934 91.006439 493.633820", "7762.374023 91.014488 534.747681", "7739.280762 91.134277 564.848328", "7639.000000 120.328026 769.771545", "7378.479980 94.512924 764.417480", "7325.039063 93.792953 820.421448", "7323.554199 95.076019 869.669067", "6920.266602 84.642204 926.835693", "6942.748047 84.112991 977.515381", "6901.287598 82.878380 1002.580750", "6848.884766 91.492271 967.189453", "6835.840820 84.595589 942.760620", "6655.309082 92.318848 793.134338", "6639.655273 91.830742 792.534058", "6635.730957 92.249802 780.763000"}));
                Patrol.Insert( new ExpansionAIPatrol(4,	"WALK", "SPRINT",     "ALTERNATE",  "Civilian",     "", true, false, 1.0, -2, -2, -2, -100,  	{"9963.346680 55.640099 10900.844727", "9965.398438 54.729034 10969.536133", "9924.380859 57.232151 10901.967773"}));
                Patrol.Insert( new ExpansionAIPatrol(4,	"WALK", "SPRINT",     "ALTERNATE",  "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"8796.84 59.8781 2547", "8745 59.1367 2523.2", "8710.44 57.5696 2499", "8794.23 55.9719 2417", "8756.99 55.8529 2370", "8782.76 56.1916 2345", "8740.17 56.1662 2304", "8751.15 56.1216 2284", "8828.47 56.6495 2234", "8764.02 53.2922 2139", "8656.02 47.4257 2009"}));
                Patrol.Insert( new ExpansionAIPatrol(4,	"WALK", "SPRINT",     "ALTERNATE",     "East",     	"", true, false, 1.0, -2, -2, -2, -100,	{"1583.58 292.804 2961", "1600.84 294.292 3006", "1631.44 295.408 3029", "1652.89 297.99 3079.6", "1685.63 297.555 3080"}));
                Patrol.Insert( new ExpansionAIPatrol(4,	"WALK", "SPRINT",     "ALTERNATE",    	"East",     	"", true, false, 1.0, -2, -2, -2, -100, {"1824.94 294.066 3075", "1884.95 293.222 3047", "1846.69 289.888 2996", "1812.78 290.333 3001", "1796.65 287.975 2990"}));
                Patrol.Insert( new ExpansionAIPatrol(4,	"WALK", "SPRINT",     "ALTERNATE",    	"West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"7160.85 84.5561 585.604", "6677.51 95.0799 770.113"}));
            break;
            case "chiemsee":
                Patrol.Insert( new ExpansionAIPatrol(3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,	{"6137.18 8.1828 14667.3", "6127.65 8.1598 14655.7", "6127.19 6.34518 14647.1"}));
                Patrol.Insert( new ExpansionAIPatrol(3, 	"WALK", "SPRINT",     "ALTERNATE",     "East",     	"", true, false, 1.0, -2, -2, -2, -100,	{"6167.18 8.1828 14667.3", "6127.65 8.1598 14655.7", "6127.19 6.34518 14647.1"}));
                Patrol.Insert( new ExpansionAIPatrol(4,	"JOG", "SPRINT",      "ALTERNATE",  "East",     	"", true, false, 1.0, -2, -2, -2, -100,	{"13342.375977 27.020344 11228.225586", "13469.069336 11.282786 11163.261719", "13567.762695 6.128973 11127.067383"}));
            ...
            case "enoch":
                ...
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",    	"ALTERNATE", 	"Civilian",     "", true, false, 1.0, -2, -2, -2, -100, {"6303.47 381.472 3911.79", "6317.71 379.912 3870.99", "6330.94 380.986 3840.62", "6337.35 381.841 3819.01", "6344.2 382.049 3788.23", "6397.86 382.435 3715.53", "6413.77 381.767 3698.73", "6447.35 381.685 3674.81", "6474.48 381.403 3664.66", "6513.5 382.929 3663.82", "6584.13 379.569 3557.25", "6637.13 366.449 3490.86", "6652.16 357.021 3435.77", "6681.99 346.724 3395.99", "6712.61 328.543 3335.31", "6727.83 322.986 3324.47", "6744.66 319.581 3326.5", "6767.47 315.498 3338.96", "6792.34 311.333 3342.37", "6826.68 303.954 3331.26", "6867.14 299.576 3324.07", "6907.82 299.158 3298.6", "6938.85 298.278 3285.71", "6976.62 300.97 3247.94", "6987.2 300.871 3203.35", "7008.57 299.646 3181.55", "7095.26 296.592 3144.57", "7187.00 295.347 3085.46"}));
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",	 	"ALTERNATE", 	"East",     	"", true, false, 1.0, -2, -2, -2, -100, {"9272.91 199.589 10826.2", "9266.68 199.532 10876.1", "9270.63 199.459 10937.9", "9250.82 198.64 10983.2", "9164.87 198.142 11063.4"}));
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",    	"ALTERNATE", 	"East",			"", true, false, 1.0, -2, -2, -2, -100,    	{"9486.09 242.261 10360.6", "9435.31 242.442 10421.8", "9394.87 238.669 10507.00", "9382.44 232.412 10558.3", "9371.1 217.304 10683.0"}));
            break;
            case "esseker":
                Patrol.Insert( new ExpansionAIPatrol(3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",      	"", true, false, 1.0, -2, -2, -2, -100,  	{"6137.18 8.1828 14667.3", "6127.65 8.1598 14655.7", "6127.19 6.34518 14647.1"}));
                Patrol.Insert( new ExpansionAIPatrol(3, 	"WALK", "SPRINT",     "ALTERNATE",     "East",      	"", true, false, 1.0, -2, -2, -2, -100, {"6167.18 8.1828 14667.3", "6127.65 8.1598 14655.7", "6127.19 6.34518 14647.1"}));
            ...
            case "namalsk":
                ...
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",     "ALTERNATE", 	"West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"6805.86 15.01 11660.4", "6867.16 15.13 11474", "6826.18 15.12 11427.5", "6765.64 15.01 11304.2", "6713.69 15 11202.7", "6605.51 15.2 10994", "6625.24 15.94 10943.1", "6634.26 16.12 10924.8", "6583.29 20.79 10864.8"}));
                ...
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"4756.11 153.16 7399.41", "5243.13 209.35 7437.1", "5272.81 271.206 7190.86", "5270.04 256.98 7017.9", "5456.37 196.30 6618.96", "5677.01 107.66 6280.14"}));
                ...
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100, 	{"5407.11 65.41 6072.06", "5246 40.67 6230.45", "4805 88.73 6460.97", "4785.95 96.61 6655.96"}));
