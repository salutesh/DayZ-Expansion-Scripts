...
class ExpansionAIPatrolSettings: ExpansionAIPatrolSettingsBase
{
    ...
    void DefaultObjectPatrols(string worldName)
    {
        ...
        {
            case "chernarusplus":
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "West", "", true, false, 1.0, -2, -2, "Wreck_UH1Y"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "", true, false, 1.0, -2, -2, "Wreck_Mi8_Crashed"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban1_police"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban2_police"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Static"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Dynamic"));
            break;
            case "enoch":
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "West", "", true, false, 1.0, -2, -2, "Wreck_UH1Y"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "", true, false, 1.0, -2, -2, "Wreck_Mi8_Crashed"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban1_police"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban2_police"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Static"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Dynamic"));
            break;
			case "deerisle":
            ...
            default:
                ...
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "ALTERNATE", "West", "", true, false, 1.0, -2, -2, "Wreck_UH1Y"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "ALTERNATE", "East", "", true, false, 1.0, -2, -2, "Wreck_Mi8_Crashed"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban1_police"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban2_police"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban1_police"));
                ObjectPatrols.Insert( new ExpansionAIObjectPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban2_police"));
                return;
            break;
	    }
    ...
    void DefaultPatrols(string worldName)
    {
        ...
        {
            case "banov":
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,	{"976.139 263.979 12683.9", "1094.76 269.075 12877.5"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"671.794 245.434 11457.6", "831.525 245.301 11211.7"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"1743.85 268.621 11658.2", "1829.22 261.877 12054.7"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"1520.8 229.459 9879.21", "1742.91 229.232 9592.4"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"1880.51 224.479 8392.91", "1921.05 221.434 8027.86"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"1884.05 227.035 6599.31", "2117.14 222.043 6418.1"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"1226.16 234.056 4521.42", "978.184 229.308 4361.1"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"640.75 250.928 3287.15", "479.013 252.843 3354.61"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"2576.35 237.181 1903.83", "2440.35 233.075 2074.31"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"3623.74 214.088 3556.15", "3760.02 214.088 3307.33"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"5200.22 201.686 4526.44", "5063.23 205.131 5062.29"}));
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",     "West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"4554.5 211.798 7601.49", "4658.85 217.283 7921.67"}));
            break;
            case "chernarusplus":
                Patrols.Insert( new ExpansionAIPatrol(-3, 	"WALK", "SPRINT",     "ALTERNATE",		"West",     	"", true, false, 1.0, -2, -2, -2, -100,  	{"4211.222656 109.023384 6382.064453", "4151.662598 105.450653 6080.294434", "4160.971680 105.412598 6035.103027", "4160.699219 106.251480 5906.830078", "4107.862793 108.930527 5898.482910", "4057.258057 114.174736 5584.595703", "4084.560059 113.232422 5494.540039", "4079.308105 113.801163 5435.953125", "4081.735840 113.402504 5385.576172", "4067.266113 109.788383 4904.508789", "4126.504883 107.371178 4647.128906"}));
