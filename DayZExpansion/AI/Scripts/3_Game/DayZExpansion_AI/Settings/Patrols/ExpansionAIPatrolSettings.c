...
class ExpansionAIPatrolSettings: ExpansionSettingBase
{
			...
			if (m_Version < VERSION)
			{
				...
				if (m_Version < 2)
				{
					...
					if (policeCrashPatrol)
					{
						...
						{
							EventCrashPatrol.Insert(new ExpansionAICrashPatrol(policeCrashPatrol.NumberOfAI, policeCrashPatrol.Speed, policeCrashPatrol.UnderThreatSpeed, policeCrashPatrol.Behaviour, policeCrashPatrol.Faction, policeCrashPatrol.LoadoutFile, policeCrashPatrol.CanBeLooted, policeCrashPatrol.UnlimitedReload, policeCrashPatrol.Chance, policeCrashPatrol.MinDistRadius, policeCrashPatrol.MaxDistRadius, policeWreck));
						}
					}
				...
				if (m_Version < 4)
				{
					...
					{
						crashPatrolv2.UpdateSettings();
					}

					foreach (ExpansionAIPatrol patrolv2: Patrol)
					{
						patrolv2.UpdateSettings();
					}
				}
    ...
    void DefaultCrashPatrols(string worldName)
    {
        ...
        {
            case "chernarusplus":
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "West", "", true, false, 1.0, -2, -2, "Wreck_UH1Y"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "", true, false, 1.0, -2, -2, "Wreck_Mi8_Crashed"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban1_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban2_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Static"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Dynamic"));
            break;
            case "enoch":
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "West", "", true, false, 1.0, -2, -2, "Wreck_UH1Y"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "", true, false, 1.0, -2, -2, "Wreck_Mi8_Crashed"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban1_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban2_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Static"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -2, -2, "ContaminatedArea_Dynamic"));
            break;
			case "deerisle":
            ...
            default:
                ...
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "ALTERNATE", "West", "", true, false, 1.0, -2, -2, "Wreck_UH1Y"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "ALTERNATE", "East", "", true, false, 1.0, -2, -2, "Wreck_Mi8_Crashed"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban1_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_sed01_aban2_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban1_police"));
                EventCrashPatrol.Insert( new ExpansionAICrashPatrol(-5, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -2, -2, "Land_Wreck_hb01_aban2_police"));
                return;
            break;
	    }
    ...
    void DefaultPatrols(string worldName)
    {
        switch (worldName)
        {
            ...
            break;
            case "namalsk":
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",     "ALTERNATE",	"West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"6307.7 14.4 11810.6", "6519.9 17.3 11901.6", "6967.4 6.5 11884.6", "7216.6 10.147 11843.1", "7405.78 23.18 11655.8"}));
                Patrol.Insert( new ExpansionAIPatrol(3, 	"WALK", "SPRINT",     "ALTERNATE", 	"West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"5028.91 7.42 11359.5", "4971.8 9.96 11305.5", "4852.96 13.88 11257.2", "4727.41 14.78 11099.7", "4690.78 21.86 10948.9", "4513.78 22.17 10819", "4333.31 15.53 11054.3", "4269.85 9.43 11046"}));
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",     "ALTERNATE", 	"West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"4492.01 3.43 10429.7", "4533.44 5.01 10371.7", "4624.5 13.35 10400.1", "4865.77 10.34 10446.7", "4964.16 2.78 10533.5", "5129.82 9.57 10510.6", "5315.19 15.77 10591", "5493.19 5.28 10593", "5524.4 14.20 10447.9", "5483.9 21.08 10348.9", "5389.42 4.64 10169.5", "5547.42 5.48 10047", "5637.03 1.09 9960", "5650.19 2.91 9899.06", "5574.11 8.27 9843.13", "5343.65 10.77 9940.64", "5154.59 14.7 9905.64", "4920.51 11.26 9685.87", "4749.81 7.86 9834.98", "4795.58 6.04 10146.9", "4580.36 6.88 10154", "4398.7 5.98 10033.1"}));
                Patrol.Insert( new ExpansionAIPatrol(5, 	"WALK", "SPRINT",     "ALTERNATE", 	"West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"6805.86 15.01 11660.4", "6867.16 15.13 11474", "6826.18 15.12 11427.5", "6765.64 15.01 11304.2", "6713.69 15 11202.7", "6605.51 15.2 10994", "6625.24 15.94 10943.1", "6634.26 16.12 10924.8", "6583.29 20.79 10864.8"}));
                Patrol.Insert( new ExpansionAIPatrol(3, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"7052.16 6.39 10051.4", "6997.08 4.0 10063.2", "6955.39 4.45 9904.53", "6881.63 5.3 9743.56", "6760.12 9.25 9758.2", "6686.01 11.36 9858.15", "6658.22 9.26 9958.59", "6762.43 7.05 10087"}));
                Patrol.Insert( new ExpansionAIPatrol(5, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"4756.11 153.16 7399.41", "5243.13 209.35 7437.1", "5272.81 271.206 7190.86", "5270.04 256.98 7017.9", "5456.37 196.30 6618.96", "5677.01 107.66 6280.14"}));
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"7674.4 75.96 8643.82", "7864.4 41.8 8563.62", "7965.19 30 8887.57", "7696.5 47.78 9120.63", "7315.1 26.6 8972.65"}));
                Patrol.Insert( new ExpansionAIPatrol(4, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"7977.68 3.93 7430.08", "7731.84 54.31 7202.23", "7475.49 72.2477 7486.18", "7667.53 33.30 7918.47", "7888.6 3.20 7997.02"}));
                Patrol.Insert( new ExpansionAIPatrol(2, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"5301.82 58.87 9602.39", "5548.07 43.18 9543.59", "5725.36 19.7 9450.14", "5476.45 29.84 9738.32"}));
                Patrol.Insert( new ExpansionAIPatrol(2, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"1198.73 2 11635.4", "1353.84 2 11604", "1351.76 2 11960.4", "1112.03 2 12009.2", "1112.48 8.92 11898.3"}));
                Patrol.Insert( new ExpansionAIPatrol(5, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100, 	{"5407.11 65.41 6072.06", "5246 40.67 6230.45", "4805 88.73 6460.97", "4785.95 96.61 6655.96"}));
                Patrol.Insert( new ExpansionAIPatrol(2, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"2914.75 4.57 11032.5", "2442.75 2 11160.6", "1997.79 2 10807", "2762.99 2 10394.4"}));
                Patrol.Insert( new ExpansionAIPatrol(2, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"5304.6 40.85 10803.6", "5612.07 47.78 10952.4", "5713.27 58.28 11090.8", "6148.22 7.7 11587.3"}));
                Patrol.Insert( new ExpansionAIPatrol(2, 	"WALK", "SPRINT",     "ALTERNATE",  "West",    		"", true, false, 1.0, -2, -2, -2, -100,  	{"4717.85 111.52 7672.94", "4311.86 129.89 7290.57", "3957.02 106.42 7239.99", "3498.03 139.88 6967.42", "3241.25 104.45 7299.5", "3663.37 90.21 7627.72", "3894.5 78.88 7776.37"}));
            break;
            case "takistanplus":
                Patrol.Insert( new ExpansionAIPatrol(1, 	"WALK", "SPRINT",     "ALTERNATE",  "Raiders",    "", true, false, 1.0, -2, -2, -2, -100,  {"1916.59 208.159 4010.34","1895.84 209.13 3960.54", "1877.69 209.431 3888.43", "1858.52 211.273 3855.79", "1805.82 211.543 3797.75", "1600.85 212.617 3613.8"}));
                Patrol.Insert( new ExpansionAIPatrol(1, 	"WALK", "SPRINT",     "ALTERNATE",  "Raiders",    "", true, false, 1.0, -2, -2, -2, -100, 	{"8030.88 158.835 7929.06", "7963.1 157.233 7962.07", "7814.7 153.932 8005.98", "7701.14 150.676 8071.15", "7600.04 147.619 8144.57", "7518.89 144.197 822.29", "7461.86 143.722 8296.28", "7390.85 141.246 8414.14"}));
                Patrol.Insert( new ExpansionAIPatrol(1,	"WALK", "SPRINT",     "ALTERNATE",  "Raiders",    "", true, false, 1.0, -2, -2, -2, -100, 	{"7555.1 288.249 1897.49", "7586.85 288.08 1907.81", "7695.77 289.716 1982.37", "7868.56 297.397 2086.09", "8066.59 296.357 2194.71"}));
            break;
            default:
