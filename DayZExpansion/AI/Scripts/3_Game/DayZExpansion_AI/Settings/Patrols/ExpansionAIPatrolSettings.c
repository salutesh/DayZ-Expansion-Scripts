...
class ExpansionAIPatrolSettings: ExpansionAIPatrolSettingsBase
{
		...
		if (settingsExist)
		{
			...
			foreach (ExpansionAIDynamicSpawnBase patrol: Patrols)
			{
				...
				if (patrol.ObjectClassName)
				{
					...
					{
						EXError.Warn(this, "Ignoring waypoints on object patrol '" + patrol.ObjectClassName + "'", {});
					}
	...
	void AddObjectPatrol(int numberOfAI = 1, string speed = "JOG", string threatSpeed = "SPRINT", string bhv = "ALTERNATE", string faction = "West", string loadout = "", bool canBeLooted = true, int unlimitedReload = 0, float chance = 1.0, float minDistRadius = -1, float maxDistRadius = -1, string objClassName = "Wreck_UH1Y")
	{
    ...
    void DefaultObjectPatrols(string worldName)
    {
        ...
        {
            case "chernarusplus":
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "West", "", true, false, 1.0, -1, -1, "Wreck_UH1Y");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "", true, false, 1.0, -1, -1, "Wreck_Mi8_Crashed");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_sed01_aban1_police");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_sed01_aban2_police");
                AddObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -1, -1, "ContaminatedArea_Static");
                AddObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -1, -1, "ContaminatedArea_Dynamic");
            break;
            case "enoch":
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "West", "", true, false, 1.0, -1, -1, "Wreck_UH1Y");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "", true, false, 1.0, -1, -1, "Wreck_Mi8_Crashed");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_hb01_aban1_police");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_hb01_aban2_police");
                AddObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -1, -1, "ContaminatedArea_Static");
                AddObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "West", "NBCLoadout", true, false, 1.0, -1, -1, "ContaminatedArea_Dynamic");
            break;
			case "deerisle":
			...
			case "sakhal":
                ...
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_sed02_aban1_Police_DE");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT_OR_ALTERNATE", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_sed02_aban2_Police_DE");
				
                AddObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "East", "NBCLoadout", true, false, 1.0, -1, -1, "ContaminatedArea_Static");
                AddObjectPatrol(-3, "JOG", "SPRINT", "HALT_OR_ALTERNATE", "East", "NBCLoadout", true, false, 1.0, -1, -1, "ContaminatedArea_Dynamic");
            break;
            default:
                ...
                AddObjectPatrol(-3, "WALK", "SPRINT", "ALTERNATE", "West", "", true, false, 1.0, -1, -1, "Wreck_UH1Y");
                AddObjectPatrol(-3, "WALK", "SPRINT", "ALTERNATE", "East", "", true, false, 1.0, -1, -1, "Wreck_Mi8_Crashed");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_sed01_aban1_police");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_sed01_aban2_police");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_hb01_aban1_police");
                AddObjectPatrol(-3, "WALK", "SPRINT", "HALT", "East", "PoliceLoadout", true, false, 1.0, -1, -1, "Land_Wreck_hb01_aban2_police");
                return;
            break;
	    }
    ...
    void DefaultPatrols(string worldName)
    {
        switch (worldName)
        {
            ...
            default:
                ...
                AddPatrol(-3, 	"WALK", "SPRINT",     "LOOP",     "West",     	"", true, false, 1.0, -1, -1, -2, -100, {"6000 0 6000", "6000 0 6500", "6500 0 6500", "6500 0 6000"});
                AddPatrol(-3, 	"WALK", "SPRINT",     "LOOP",     "East",     	"", true, false, 1.0, -1, -1, -2, -100, {"6500 0 6500", "6000 0 6500", "6000 0 6000", "6500 0 6000"});
                AddPatrol(1, 	"SPRINT", "SPRINT",   "ALTERNATE",     "Raiders",	"", true, false, 1.0, -1, -1, -2, -100, {"6000 0 6000", "6250 0 6250", "6500 0 6500"});
                return;
            break;
        }
        if ( GetExpansionSettings().GetLog().AIPatrol )
