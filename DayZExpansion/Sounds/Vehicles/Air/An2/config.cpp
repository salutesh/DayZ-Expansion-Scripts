...
class CfgSoundShaders
{
	...
	class Expansion_An2_Engine_Int_SoundShader: Expansion_An2_Base_Int_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Vehicles\Air\An2\Expansion_An2_Engine_Int",
				1
			}
		};
		frequency="rpm";
	...
	class Expansion_An2_Engine_Ext_SoundShader: Expansion_An2_Base_Ext_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Vehicles\Air\An2\Expansion_An2_Engine_Ext",
				1
			}
		};
		frequency="rpm";
...
class CfgSoundSets
{
	...
	class Expansion_An2_Engine_Int_SoundSet: Expansion_An2_Base_Int_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_An2_Engine_Int_SoundShader"
		};
		volumeFactor=1;
	};
	class Expansion_An2_Engine_Ext_SoundSet: Expansion_An2_Base_Ext_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_An2_Engine_Ext_SoundShader"
		};
		volumeFactor=1;
	};
};
