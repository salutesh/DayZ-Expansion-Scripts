...
class CfgSoundSets
{
	...
	class Vehicle_Hatchback_02_damper_left_SoundSet: baseVehicles_SoundSet
	{
		soundShaders[]=
		{
			"Hatchback_02_damper_metal_SoundShader"
		};
	...
	class Vehicle_Hatchback_02: ExpansionVehicleCarBase
	{
		class ExpansionSounds
		{
			...
			soundSetsFilter[]=
			{
				...
				"Vehicle_Hatchback_02_damper_left_SoundSet",
				"Vehicle_Hatchback_02_damper_right_SoundSet"
			};
			soundSetsInt[]=
			{
				"Hatchback_02_Tires_Asphalt_Fast_General_Int_SoundSet",
				"Hatchback_02_Wind_SoundSet"
			};
		};
	};
};
