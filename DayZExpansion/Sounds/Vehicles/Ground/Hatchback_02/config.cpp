...
class CfgPatches
{
	class DayZExpansion_Sounds_Ground_Vehicle_Hatchback_02
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgSoundSets
{
	...
	class Vehicle_Hatchback_02_damper_left_SoundSet: baseVehicles_SoundSet
	{
		soundShaders[] = {"Hatchback_02_damper_metal_SoundShader"};
	...
	class Vehicle_Hatchback_02_damper_right_SoundSet: baseVehicles_SoundSet
	{
		soundShaders[] = {"Hatchback_02_damper_metal_SoundShader"};
		volumeFactor = 0.5;
		frequencyFactor = 1;
	...
	class Vehicle_Hatchback_02_Engine_Thrust_Down_SoundSet: baseVehicles_SoundSet
	{
