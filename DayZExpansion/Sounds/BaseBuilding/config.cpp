...
class CfgSoundShaders
{
	...
	class Expansion_CodeLock_Locks_SoundShader: Expansion_BaseBuilding_SoundShader
	{
		samples[]=
		{
			...
			{
				"\DayZExpansion\Sounds\BaseBuilding\Expansion_Codelock_Lock_01",
				1
			},
			
			{
				"\DayZExpansion\Sounds\BaseBuilding\Expansion_Codelock_Lock_02",
				1
			},
			
			{
				"\DayZExpansion\Sounds\BaseBuilding\Expansion_Codelock_Lock_03",
				1
			}
		};
	};
	...
	class Expansion_CodeLock_Unlock1_SoundShader: Expansion_BaseBuilding_SoundShader
	{
		samples[]=
		{
			...
			{
				"\DayZExpansion\Sounds\BaseBuilding\Expansion_Codelock_Unlock_01",
				1
			}
		};
	};
	class Expansion_ParkingMeter_Activated_SoundShader: Expansion_BaseBuilding_SoundShader
	{
		...
		samples[]=
		{
			...
			{
				"\DayZExpansion\Sounds\BaseBuilding\Parking_Meter_Activated_01",
				1
			}
		};
	};
...
class CfgSoundSets
{
	...
	class Expansion_CodeLock_Locks_SoundSet: Expansion_BaseBuilding_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_CodeLock_Locks_SoundShader"
		};
	};
	class Expansion_CodeLock_Lock1_SoundSet: Expansion_BaseBuilding_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_CodeLock_Lock1_SoundShader"
		};
	};
	class Expansion_CodeLock_Lock2_SoundSet: Expansion_BaseBuilding_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_CodeLock_Lock2_SoundShader"
		};
	};
	class Expansion_CodeLock_Lock3_SoundSet: Expansion_BaseBuilding_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_CodeLock_Lock3_SoundShader"
		};
	};
	class Expansion_CodeLock_Unlock1_SoundSet: Expansion_BaseBuilding_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_CodeLock_Unlock1_SoundShader"
		};
	};
	class Expansion_ParkingMeter_Activated_SoundSet: Expansion_BaseBuilding_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_ParkingMeter_Activated_SoundShader"
		};
	};
};
