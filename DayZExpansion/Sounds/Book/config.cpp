...
class CfgSoundShaders
{
	...
	class Expansion_OpenBook_SoundShader: Expansion_Book_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Book\sound_book_page1",
				1
			}
		};
	};
	class Expansion_SwitchPage_SoundShader: Expansion_Book_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Book\sound_book_page2",
				1
			},
			
			{
				"DayZExpansion\Sounds\Book\sound_book_page3",
				1
			},
			
			{
				"DayZExpansion\Sounds\Book\sound_book_page4",
				1
			}
		};
	};
	class Expansion_CloseBook_SoundShader: Expansion_Book_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Book\sound_book_close",
				1
			}
		};
	};
...
class CfgSoundSets
{
	...
	class Expansion_OpenBook_SoundSet: Expansion_Book_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_OpenBook_SoundShader"
		};
	};
	class Expansion_SwitchPage_SoundSet: Expansion_Book_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_SwitchPage_SoundShader"
		};
	};
	class Expansion_CloseBook_SoundSet: Expansion_Book_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_CloseBook_SoundShader"
		};
	};
};
