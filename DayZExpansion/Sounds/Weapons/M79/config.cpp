...
class CfgPatches
{
	class DayZExpansion_Sounds_Weapons_M79
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Characters","DZ_Sounds_Effects"};
	};
};
class CfgSoundShaders
{
	...
	{
		samples[] = {{"DayZExpansion\Sounds\Weapons\M79\m79_shot_mid.ogg",1}};
		volume = 1.1220185;
	};
	class Expansion_M79_distShot_SoundShader: base_distShot_SoundShader
	{
		samples[] = {{"DayZExpansion\Sounds\Weapons\M79\m79_shot_long.ogg",1}};
		volume = 1.1220185;
	};
};
class CfgSoundSets
{
	...
	{
		soundShaders[] = {"Expansion_M79_closeShot_SoundShader","Expansion_M79_midShot_SoundShader","Expansion_M79_distShot_SoundShader"};
	};
};
