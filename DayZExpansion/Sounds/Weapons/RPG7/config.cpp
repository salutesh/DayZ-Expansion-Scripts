...
class CfgSoundShaders
{
	...
	class Expansion_RPG7_Reload1_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Weapons\RPG7\Expansion_RPG7_Reload1",
				1
			}
		};
		volume=1;
	...
	class Expansion_RPG7_Reload2_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Weapons\RPG7\Expansion_RPG7_Reload2",
				1
			}
		};
		volume=1;
	...
	class Expansion_RPG7_Reload3_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Weapons\RPG7\Expansion_RPG7_Reload3",
				1
			}
		};
		volume=1;
	...
	class Expansion_RPG_closeShot_SoundShader: base_closeShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Weapons\RPG7\Expansion_RPG7_Rocket",
				1
			}
		};
		volume=0.89999998;
	...
	class Expansion_RPG_midShot_SoundShader: base_midShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Weapons\RPG7\Expansion_RPG7_Rocket_mid",
				1
			}
		};
		volume=0.44999999;
	...
	class Expansion_RPG_distShot_SoundShader: base_distShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Weapons\RPG7\Expansion_RPG7_Rocket_long",
				1
			}
		};
		volume=0.15000001;
	...
	class Expansion_RPG_Shove_SoundShader: reloadWeapon_SoundShader
	{
		samples[]=
		{
			...
			{
				"DayZExpansion\Sounds\Weapons\RPG7\Expansion_RPG7_Shove1.ogg",
				1
			},
			
			{
				"DayZExpansion\Sounds\Weapons\RPG7\Expansion_RPG7_Shove2.ogg",
				1
			},
			
			{
				"DayZExpansion\Sounds\Weapons\RPG7\Expansion_RPG7_Shove3.ogg",
				1
			}
		};
		volume=1;
...
class CfgSoundSets
{
	...
	class Expansion_RPG7_Reload1_SoundSet: baseCharacter_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_RPG7_Reload1_SoundShader"
		};
	};
	class Expansion_RPG7_Reload2_SoundSet: baseCharacter_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_RPG7_Reload2_SoundShader"
		};
	};
	class Expansion_RPG7_Reload3_SoundSet: baseCharacter_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_RPG7_Reload3_SoundShader"
		};
	};
	class Expansion_RPG7_BagShuffle_SoundSet: baseCharacter_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_RPG_BagShuffle_SoundShader"
		};
	};
	class Expansion_RPG7_Shove_SoundSet: baseCharacter_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_RPG_Shove_SoundShader"
		};
	};
	class Expansion_RPG_Shot_SoundSet: Rifle_Shot_Base_SoundSet
	{
		soundShaders[]=
		{
			"Expansion_RPG_closeShot_SoundShader",
			"Expansion_RPG_midShot_SoundShader",
			"Expansion_RPG_distShot_SoundShader"
		};
	};
};
class CfgVehicles
