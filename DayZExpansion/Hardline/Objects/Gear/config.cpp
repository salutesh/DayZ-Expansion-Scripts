...
class cfgVehicles
{
	...
	class Dogtag_Scout: Dogtag_Survivor
	{
		...
		{
			"#(argb,8,8,3)color(0.6,0.9,0,1.0,CO)"
		};
	};
	class Dogtag_Pathfinder: Dogtag_Survivor
	{
		...
		hiddenSelectionsTextures[]=
		{
			"#(argb,8,8,3)color(0.6,0.9,1.0,1.0,CO)"
		};
	};
	...
	class Dogtag_Legend: Dogtag_Survivor
	{
		...
		hiddenSelectionsTextures[]=
		{
			"#(argb,8,8,3)color(0.9,0.5,0.1,1.0,CO)"
		};
	};
	class Dogtag_Kleptomaniac: Dogtag_Survivor
	{
		...
		hiddenSelectionsTextures[]=
		{
			"#(argb,8,8,3)color(0.9,1.0,0.1,1.0,CO)"
		};
	};
	class Dogtag_Bully: Dogtag_Survivor
	{
		...
		hiddenSelectionsTextures[]=
		{
			"#(argb,8,8,3)color(0.8,0,0.7,1.0,CO)"
		};
	};
	...
	class Dogtag_Madman: Dogtag_Survivor
	{
		...
		hiddenSelectionsTextures[]=
		{
			"#(argb,8,8,3)color(1.0,0,0,1.0,CO)"
		};
	};
};
