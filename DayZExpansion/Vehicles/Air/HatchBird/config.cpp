...
class CfgVehicles
{
	...
	class ExpansionHatchBird: OffroadHatchback
	{
		...
		class Sounds
		{
			...
			soundSetsFilter[] = {"Expansion_HatchBird_Engine_Ext_SoundSet","Expansion_HatchBird_Rotor_Ext_SoundSet"};
			soundSetsInt[] = {"Expansion_HatchBird_Engine_Int_SoundSet","Expansion_HatchBird_Rotor_Int_SoundSet"};
		};
		...
		class DamageSystem: DamageSystem
		{
			class DamageZones: DamageZones
			{
				class Front: Front
				{
					class Health: Health
					{
						healthLevels[] = {{1,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_body.rvmat"}},{0.7,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_body.rvmat"}},{0.5,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_body_damage.rvmat"}},{0.3,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_body_damage.rvmat"}},{0,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_body_destruct.rvmat"}}};
					};
				};
			};
		};
	...
	class ExpansionHatchBirdDoors_Driver: CarDoor
	{
		...
		rotationFlags = 8;
		hiddenSelectionsMaterials[] = {"DayZExpansion\Vehicles\Air\HatchBird\data\niva_door.rvmat"};
		defaultSkin = "HatchBird";
		class DamageSystem: DamageSystem
		{
			...
			class DamageZones: DamageZones
			{
				...
				class Doors: Doors
				{
					class Health: Health
					{
						RefTexsMats[] = {"DayZExpansion\Vehicles\Air\HatchBird\data\niva_door.rvmat"};
						healthLevels[] = {{1,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_door.rvmat"}},{0.7,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_door.rvmat"}},{0.5,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_door_damage.rvmat"}},{0.3,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_door_damage.rvmat"}},{0,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_door_destruct.rvmat"}}};
					};
				};
			};
		};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					hitpoints = 500;
					RefTexsMats[] = {"DayZExpansion\Vehicles\Air\HatchBird\data\niva_hood.rvmat"};
					healthLevels[] = {{1,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_hood.rvmat"}},{0.7,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_hood.rvmat"}},{0.5,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_hood_damage.rvmat"}},{0.3,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_hood_damage.rvmat"}},{0,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_hood_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
		...
		class DamageSystem: DamageSystem
		{
			class DamageZones: DamageZones
			{
				...
				class Doors: Doors
				{
					...
					{
						RefTexsMats[] = {"DayZExpansion\Vehicles\Air\HatchBird\data\niva_trunk.rvmat"};
						healthLevels[] = {{1,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_trunk.rvmat"}},{0.7,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_trunk.rvmat"}},{0.5,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_trunk_damage.rvmat"}},{0.3,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_trunk_damage.rvmat"}},{0,{"DayZExpansion\Vehicles\Air\HatchBird\data\niva_trunk_destruct.rvmat"}}};
					};
				};
			};
		};
