...
class CfgVehicles
{
	...
	class ExpansionSpraycanWine: ExpansionSpraycanBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\DayZExpansion\Objects\Gear\Spraycans\data\spraycan_wine_co.paa"
		};
		skinName="Wine";
	};
	...
	class ExpansionSpraycanBanditKitty: ExpansionSpraycanBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\DayZExpansion\Objects\Gear\Spraycans\data\spraycan_pink_co.paa"
		};
