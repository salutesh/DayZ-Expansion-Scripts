...
class CfgVehicles
{
	...
	class ExpansionUtilityBoat: ExpansionBoatScript
	{
		...
		hiddenSelectionsTextures[]=
		{
			"",
			"",
			"DayZExpansion\Vehicles\Water\Utility\data\rhib_co.paa",
			""
		};
		hiddenSelectionsMaterials[]=
		{
			"",
			"",
			"DayZExpansion\Vehicles\Water\Utility\data\rhib.rvmat",
			""
		};
		...
		class Sounds
		{
			...
			soundSetsFilter[]=
			{
				"Expansion_Utility_Engine_Ext_SoundSet",
				...
				"Expansion_Utility_Idle_Ext_SoundSet",
