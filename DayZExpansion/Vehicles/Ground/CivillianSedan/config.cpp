...
class CfgVehicles
{
		...
		class DamageSystem
		{
			...
			class DamageZones
			{
				...
				class Front
				{
					...
					inventorySlotsCoefs[]={0.69999999,0.5,0.69999999,0.69999999};
				};
				class Reflector_1_1
				{
					fatalInjuryCoef=-1;
	...
	class CivilianSedan: CarScript
	{
		...
		applySkinsTo[]=
		{
			...
			"CivSedanHood",
			"CivSedanTrunk",
			"Expansion_CivSedanDoors_Driver",
			"Expansion_CivSedanDoors_CoDriver",
			"Expansion_CivSedanDoors_BackLeft",
			"Expansion_CivSedanDoors_BackRight",
			"Expansion_CivSedanHood",
			"Expansion_CivSedanTrunk"
		};
		defaultSkin="White";
		attachments[]+=
		{
