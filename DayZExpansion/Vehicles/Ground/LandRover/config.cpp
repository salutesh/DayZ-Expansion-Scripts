...
class CfgVehicles
{
	...
	class Expansion_Landrover_Driverdoor: CarDoor
	{
		...
		hiddenSelectionsMaterials[]=
		{
			"",
			"",
			"dayzexpansion\vehicles\ground\landrover\data\lr_body_outdoor.rvmat",
			"dayzexpansion\vehicles\ground\landrover\data\lr_body_inside.rvmat"
		};
		class DamageSystem
		{
			class GlobalHealth
					...
					class Health
					{
						...
						healthLevels[]=
						{
							
							{
								...
								{
									"dayzexpansion\vehicles\ground\landrover\data\lr_windows.rvmat"
								}
							},
							
							{
								...
								{
									"DayZExpansion\Vehicles\Ground\LandRover\data\lr_windows_damage.rvmat"
								}
							},
							...
							
							{
								...
								{
									"DayZExpansion\Vehicles\Ground\LandRover\data\lr_windows_destruct.rvmat"
								}
							},
	...
	class Expansion_Landrover_Wheel: CarWheel
	{
		...
		rotationFlags=8;
		physLayer="item_large";
		radiusByDamage[]={0,0.40799999,0.30000001,0.40000001,0.99980003,0.25,0.99989998,0.2};
		radius=0.36899999;
		width=0.15000001;
		friction=0.85000002;
		...
		{
			"",
			"dayzexpansion\vehicles\ground\landrover\data\lr_bottom_metal.rvmat",
			"dayzexpansion\vehicles\ground\landrover\data\lr_bottom.rvmat"
		};
		class DamageSystem
		{
			class GlobalHealth
	...
	class Expansion_Landrover_Base: CarScript
	{
		...
		class SimulationModule
		{
			...
			class Brake
			{
				pressureBySpeed[]={0,0.89999998,10,0.85000002,20,0.80000001,50,0.69999999,80,0.80000001,100,1};
			...
			class Gearbox
			{
				type="GEARBOX_MANUAL";
				reverse=3.9260001;
				ratios[]={5.0770001,3.4260001,2.6010001,2.188,1.775,1.3049999};
			};
		...
		class DamageSystem
		{
			...
			class DamageZones
			{
				...
				class Front
				{
					...
					transferTozonesThreshold[]={0.5,0.80000001,0.80000001,0.80000001};
					transferTozonesCoefs[]={0.80000001,0.60000002,0.60000002,0.60000002};
					memoryPoints[]=
					{
						"dmgzone_front"
					};
					...
					class Health
					{
						...
						healthLevels[]=
						{
							
							{
								...
								{
									"dayzexpansion\vehicles\ground\landrover\data\lr_headlights.rvmat"
								}
							},
