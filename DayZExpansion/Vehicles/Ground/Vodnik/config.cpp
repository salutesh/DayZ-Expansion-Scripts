...
class CfgVehicles
{
	...
	class ExpansionVodnik: ExpansionBoatScript
	{
		...
		class SimulationModule: SimulationModule
		{
			...
			class Gearbox
			{
				type="GEARBOX_MANUAL";
				reverse=3.4260001;
				ratios[]={3.0670002,1.9999999,1.2609999,0.89999998};
			};
		...
		class DamageSystem
		{
			...
			class DamageZones
			{
				...
				class Engine
				{
					...
					inventorySlotsCoefs[]={0.039999999,0.039999999,0.039999999};
				};
				class Radiator
				{
					class Health
	...
	class ExpansionSpraycanCamo: ExpansionSpraycanBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\DayZExpansion\Objects\Gear\Spraycans\data\spraycan_camo_co.paa"
		};
		skinName="Camo";
	};
