...
class CfgPatches
{
	...
	{
		units[] = {"ExpansionUAZWheel","ExpansionUAZWheelTest","ExpansionUAZDoorDriver","ExpansionUAZDoorCoDriver","ExpansionUAZDoorCargo1","ExpansionUAZDoorCargo2","ExpansionUAZDoorTrunk","ExpansionUAZ","ExpansionUAZRoofless","ExpansionUAZCargoRoofless","ExpansionUAZCargo","ExpansionUAZCargoRooflessTest","ExpansionSpraycanGreen","ExpansionUAZ_Green","ExpansionUAZCargo_Green","ExpansionUAZRoofless_Green","ExpansionUAZCargoRoofless_Green","ExpansionUAZDoorDriver_Green","ExpansionUAZDoorCoDriver_Green","ExpansionUAZDoorCargo1_Green","ExpansionUAZDoorCargo2_Green","ExpansionSpraycanBlack","ExpansionUAZ_Black","ExpansionUAZCargo_Black","ExpansionUAZRoofless_Black","ExpansionUAZCargoRoofless_Black","ExpansionUAZDoorDriver_Black","ExpansionUAZDoorCoDriver_Black","ExpansionUAZDoorCargo1_Black","ExpansionUAZDoorCargo2_Black"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class ExpansionUAZWheelTest: ExpansionWheel
	{
		scope = 2;
		displayName = "UAZ Wheel - Test";
		descriptionShort = "$STR_EXPANSION_VEHICLE_UAZ_WHEEL_DESC";
		model = "\DayZExpansion\Vehicles\Ground\UAZ\proxy\UAZWheel.p3d";
		weight = 15000;
		inventorySlot[] = {"uazwheel_1_1","uazwheel_1_2","uazwheel_2_1","uazwheel_2_2"};
	...
	class ExpansionUAZCargoRooflessTest: ExpansionCarScript
	{
		scope = 2;
		displayname = "TEST - UAZ 469 Cargo Roofless";
		model = "\DayZExpansion\Vehicles\Ground\UAZ\UAZCargoRoofless.p3d";
		vehicleClass = "Expansion_Car";
		attachments[] = {"CarBattery","Reflector_1_1","Reflector_2_1","CarRadiator","SparkPlug","uazwheel_1_1","uazwheel_1_2","uazwheel_2_1","uazwheel_2_2","uazdriverdoor","uazcodriverdoor","uazcargo1door","uazcargo2door"};
		doors[] = {"uazdriverdoor","uazcodriverdoor","uazcargo1door","uazcargo2door"};
