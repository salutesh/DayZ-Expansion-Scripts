...
class CfgPatches
{
	...
	{
		units[] = {"ExpansionTractorFrontWheel","ExpansionTractorBackWheel","ExpansionTractorDoorsDriver","ExpansionTractorDoorsCodriver","ExpansionTractor","ExpansionSpraycanRed","ExpansionTractor_Red","ExpansionTractorDoorsDriver_Red","ExpansionTractorDoorsCodriver_Red","ExpansionTractorFrontWheel_Red","ExpansionTractorBackWheel_Red","ExpansionSpraycanBlue","ExpansionTractor_Blue","ExpansionTractorDoorsDriver_Blue","ExpansionTractorDoorsCodriver_Blue","ExpansionTractorFrontWheel_Blue","ExpansionTractorBackWheel_Blue","ExpansionSpraycanGreen","ExpansionTractor_Green","ExpansionTractorDoorsDriver_Green","ExpansionTractorDoorsCodriver_Green","ExpansionTractorFrontWheel_Green","ExpansionTractorBackWheel_Green"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class ExpansionTractorDoorsDriver_Red: ExpansionTractorDoorsDriver
	{
		skinBase = "ExpansionTractorDoorsDriver";
		skinName = "Red";
	};
	class ExpansionTractorDoorsCodriver_Red: ExpansionTractorDoorsCodriver
	{
		skinBase = "ExpansionTractorDoorsCodriver";
		skinName = "Red";
	};
	class ExpansionTractorFrontWheel_Red: ExpansionTractorFrontWheel
	{
		skinBase = "ExpansionTractorFrontWheel";
		skinName = "Red";
	};
	class ExpansionTractorBackWheel_Red: ExpansionTractorBackWheel
	{
		skinBase = "ExpansionTractorBackWheel";
		skinName = "Red";
	};
	...
	class ExpansionTractorDoorsDriver_Blue: ExpansionTractorDoorsDriver
	{
		skinBase = "ExpansionTractorDoorsDriver";
		skinName = "Blue";
	};
	class ExpansionTractorDoorsCodriver_Blue: ExpansionTractorDoorsCodriver
	{
		skinBase = "ExpansionTractorDoorsCodriver";
		skinName = "Blue";
	};
	class ExpansionTractorFrontWheel_Blue: ExpansionTractorFrontWheel
	{
		skinBase = "ExpansionTractorFrontWheel";
		skinName = "Blue";
	};
	class ExpansionTractorBackWheel_Blue: ExpansionTractorBackWheel
	{
		skinBase = "ExpansionTractorBackWheel";
		skinName = "Blue";
	};
	...
	class ExpansionTractorDoorsDriver_Green: ExpansionTractorDoorsDriver
	{
		skinBase = "ExpansionTractorDoorsDriver";
		skinName = "Green";
	};
	class ExpansionTractorDoorsCodriver_Green: ExpansionTractorDoorsCodriver
	{
		skinBase = "ExpansionTractorDoorsCodriver";
		skinName = "Green";
	};
	class ExpansionTractorFrontWheel_Green: ExpansionTractorFrontWheel
	{
		skinBase = "ExpansionTractorFrontWheel";
		skinName = "Green";
	};
	class ExpansionTractorBackWheel_Green: ExpansionTractorBackWheel
	{
		skinBase = "ExpansionTractorBackWheel";
		skinName = "Green";
	};
