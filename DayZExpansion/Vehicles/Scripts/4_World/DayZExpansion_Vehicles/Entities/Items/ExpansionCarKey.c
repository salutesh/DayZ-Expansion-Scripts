					...
					else
					{
						...
						if (!FileExist(fileName))
						{
							...
							if (file)
							{
								...
								FPrintln(file, "{");
								FPrintln(file, "	class GUIInventoryAttachmentsProps;");
								FPrintln(file, "	class Body;");
								FPrintln(file, "	class " + vehicleBase + ";");
								FPrintln(file, "	class " + vehicleType + ": " + vehicleBase);
								FPrintln(file, "	{");
								FPrintln(file, "		attachments[] += {\"KeyChain\"};");
								FPrintln(file, "		class GUIInventoryAttachmentsProps: GUIInventoryAttachmentsProps");
								FPrintln(file, "		{");
								FPrintln(file, "			class Body: Body");
								FPrintln(file, "			{");
								FPrintln(file, "				attachmentSlots[] += {\"KeyChain\"};");
								FPrintln(file, "			};");
								FPrintln(file, "		};");
								FPrintln(file, "	};");
								FPrintln(file, "};");
