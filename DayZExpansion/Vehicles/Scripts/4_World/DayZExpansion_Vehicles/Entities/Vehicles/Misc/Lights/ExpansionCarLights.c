...
class ExpansionRearCarLights: CarRearLightBase
{
	void ExpansionRearCarLights()
	{
		...
		auto trace = CF_Trace_0(ExpansionTracing.VEHICLES, this, "ExpansionRearCarLights");
#endif
...
class ExpansionCarFrontLight: CarLightBase
{
	...
	{
#ifdef EXPANSIONTRACE
		auto trace = CF_Trace_0(ExpansionTracing.VEHICLES, this, "ExpansionCarFrontLight");
#endif
