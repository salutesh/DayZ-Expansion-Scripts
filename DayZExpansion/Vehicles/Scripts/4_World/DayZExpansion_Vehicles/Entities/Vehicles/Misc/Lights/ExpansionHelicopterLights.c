...
class ExpansionRearHelicopterLights extends CarRearLightBase
{
	void ExpansionRearHelicopterLights()
	{
		...
		EXPrint("ExpansionRearHelicopterLights::Constructor - Start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionRearHelicopterLights::Constructor - End");
		#endif
	}
}
...
class ExpansionHelicopterFrontLight extends CarLightBase
{
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionHelicopterFrontLight::Constructor - Start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionHelicopterFrontLight::Constructor - End");
		#endif
	}
}