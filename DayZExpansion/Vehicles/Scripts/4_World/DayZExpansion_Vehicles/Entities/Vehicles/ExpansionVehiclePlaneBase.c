...
class ExpansionVehiclePlaneBase extends ExpansionVehicleBase
{
	...
	*/
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint( "ExpansionVehiclePlaneBase::PerformGroundRaycast - Start" );
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint( "ExpansionVehiclePlaneBase::PerformGroundRaycast - End" );
		#endif
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehiclePlaneBase::SetActions - Start");
		#endif

		super.SetActions();

		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehiclePlaneBase::SetActions - End");
		#endif
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehiclePlaneBase::OnEngineStop - Start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehiclePlaneBase::OnEngineStop - End");
		#endif
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehiclePlaneBase::OnEngineStart - Start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehiclePlaneBase::OnEngineStart - End");
		#endif
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehiclePlaneBase::ExpansionOnSpawnExploded - Start");
		#endif

		super.ExpansionOnSpawnExploded();

		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehiclePlaneBase::ExpansionOnSpawnExploded - End");
		#endif
	}
