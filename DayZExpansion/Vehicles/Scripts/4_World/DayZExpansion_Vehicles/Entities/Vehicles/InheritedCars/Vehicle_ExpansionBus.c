...
class Vehicle_ExpansionBus extends ExpansionVehicleCarBase
{
	...
	void Vehicle_ExpansionBus()
	{
		...
		EXPrint("Vehicle_ExpansionBus::Constructor - Start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::Constructor - End");
		#endif
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::Deconstructor - Start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::Deconstructor - End");
		#endif
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::GetAnimInstance");
		#endif
		...
		if ( !GetGame().IsServer()  ||  !GetGame().IsMultiplayer() ) // client side
		{
			...
			if (battery)
			{
				if (m_HeadlightsOn)
				{
					...
					{
						if ( IsInherited( Vehicle_ExpansionBus ) ) 
						{
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::GetSeatAnimationType");
		#endif
	...
	override int GetCarDoorsState( string slotType )
	{
		...
		*/
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::GetCarDoorsState");
		#endif
	...
	*/
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::CanReachDoorsFromSeat");
		#endif
...
*/
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::IsVitalCarBattery");
		#endif
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::IsVitalTruckBattery");
		#endif
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::IsVitalSparkPlug");
		#endif
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::IsVitalRadiator");
		#endif
		return true;
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::IsVitalGlowPlug");
		#endif
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("Vehicle_ExpansionBus::IsVitalEngineBelt");
		#endif
