...
class ExpansionVehicleBoatBase extends ExpansionVehicleCarBase
{
	...
	void ExpansionVehicleBoatBase()
	{
		...
		EXPrint("ExpansionVehicleBoatBase::Constructor start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehicleBoatBase::Constructor end");
		#endif
	}
	...
	protected override void OnSimulation( float pDt, out vector force, out vector torque )
	{
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehicleBoatBase::UpdatePhysics end");
		#endif
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehicleBoatBase::ExpansionOnExplodeClient start");
		#endif
		super.ExpansionOnExplodeClient( damageType, ammoType );

		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehicleBoatBase::ExpansionOnExplodeClient end");
		#endif
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehicleBoatBase::ExpansionOnSpawnExploded - Start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehicleBoatBase::ExpansionOnSpawnExploded - End");
		#endif
	}
	...
	{
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehicleBoatBase::DeferredInit start");
		#endif
		...
		#ifdef EXPANSIONEXPRINT
		EXPrint("ExpansionVehicleBoatBase::DeferredInit end");
		#endif
	}
