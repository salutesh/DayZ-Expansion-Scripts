#ifdef CF_MVVM
class ExpansionVehicleAltimeterUI : ExpansionVehicleComponentUI
{
	float m_Altimeter_Rotation;
	int m_Altitude;

	void ExpansionVehicleAltimeterUI(ExpansionVehicleBase vehicle, ExpansionVehicleComponent module, Widget parent)
	{
	}
