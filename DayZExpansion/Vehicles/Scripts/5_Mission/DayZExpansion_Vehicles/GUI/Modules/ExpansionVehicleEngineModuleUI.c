#ifdef CF_MVVM
class ExpansionVehicleEngineModuleUI : ExpansionVehicleModuleUI
{
	...
	void ExpansionVehicleEngineModuleUI(ExpansionVehicleBase vehicle, ExpansionVehicleModule module, Widget parent)
	{
