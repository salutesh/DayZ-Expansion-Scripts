...
class CfgPatches
{
	...
	{
		units[] = {"ExpansionStaticKeyGrinder","ExpansionCarKey","ExpansionCarAdminKey","GlowPlug","ExpansionIgniterPlug","ExpansionHydraulicHoses","ExpansionHelicopterBattery","ExpansionAircraftBattery","ExpansionUniversalWheel"};
		weapons[] = {};
		requiredVersion = 0.1;
