		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[] = {{1,{"DZ\Characters\backpacks\data\dryBag.rvmat"}},{0.7,{"DZ\Characters\backpacks\data\dryBag.rvmat"}},{0.5,{"DZ\Characters\backpacks\data\dryBag_damage.rvmat"}},{0.3,{"DZ\Characters\backpacks\data\dryBag_damage.rvmat"}},{0,{"DZ\Characters\backpacks\data\dryBag_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
