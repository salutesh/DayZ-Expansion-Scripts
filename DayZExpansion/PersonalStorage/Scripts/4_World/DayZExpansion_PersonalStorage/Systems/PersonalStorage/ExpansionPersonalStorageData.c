...
class ExpansionPersonalStorageData: ExpansionPersonalStorageDataBase
{
	...
	void Save()
	{
		ExpansionJsonFileParser<ExpansionPersonalStorageData>.Save(ExpansionPersonalStorageModule.GetPersonalStorageDirectory() + "PersonalStorage_" + StorageID + ".json", this);
	}
	
	static void Save(ExpansionPersonalStorageData personalStorageData)
	{
		ExpansionJsonFileParser<ExpansionPersonalStorageData>.Save(ExpansionPersonalStorageModule.GetPersonalStorageDirectory() + "PersonalStorage_" + personalStorageData.StorageID + ".json", personalStorageData);
	}
