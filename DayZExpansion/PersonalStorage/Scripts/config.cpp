	...
	class DZ_Expansion_PersonalStorage
	{
		...
		class defs
		{
			...
			class engineScriptModule
			{
				...
				files[]=
				{
					"DayZExpansion/PersonalStorage/Scripts/Common",
					"DayZExpansion/PersonalStorage/Scripts/1_Core"
				};
			};
			class gameLibScriptModule
			{
				...
				{
					"DayZExpansion/PersonalStorage/Scripts/Common",
					"DayZExpansion/PersonalStorage/Scripts/2_GameLib"
				};
			};
			class gameScriptModule
			{
				...
				{
					"DayZExpansion/PersonalStorage/Scripts/Common",
					"DayZExpansion/PersonalStorage/Scripts/3_Game"
				};
			};
			class worldScriptModule
			{
				...
				{
					"DayZExpansion/PersonalStorage/Scripts/Common",
					"DayZExpansion/PersonalStorage/Scripts/4_World"
				};
			};
			class missionScriptModule
			{
				...
				{
					"DayZExpansion/PersonalStorage/Scripts/Common",
					"DayZExpansion/PersonalStorage/Scripts/5_Mission"
				};
			};
		};
	};
