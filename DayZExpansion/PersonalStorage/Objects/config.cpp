...
class CfgVehicles
{
	...
	class ExpansionPersonalProtectiveCaseBase: Container_Base
	{
		...
		inventorySlot[]=
		{
			"ExpansionPersonalContainer",
			"ExpansionPersonalContainer_Swap"
		};
		rotationFlags=17;
		weight=980;
		itemSize[]={3,4};
	...
	class ExpansionPersonalProtectiveCaseAlpha: ExpansionPersonalProtectiveCaseBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\PersonalStorage\Objects\ProtectorCase\data\expansion_protectorcase_orange_co.paa"
		};
	};
	class ExpansionPersonalProtectiveCaseBeta: ExpansionPersonalProtectiveCaseBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\PersonalStorage\Objects\ProtectorCase\data\expansion_protectorcase_red_co.paa"
		};
	};
	class ExpansionPersonalProtectiveCaseGamma: ExpansionPersonalProtectiveCaseBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\PersonalStorage\Objects\ProtectorCase\data\expansion_protectorcase_green_co.paa"
		};
	};
	class ExpansionPersonalProtectiveCaseDelta: ExpansionPersonalProtectiveCaseBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\PersonalStorage\Objects\ProtectorCase\data\expansion_protectorcase_purple_co.paa"
		};
	};
	class ExpansionPersonalProtectiveCaseEpsilon: ExpansionPersonalProtectiveCaseBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\PersonalStorage\Objects\ProtectorCase\data\expansion_protectorcase_blue_co.paa"
		};
	};
	class ExpansionPersonalProtectiveCaseOmega: ExpansionPersonalProtectiveCaseBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\PersonalStorage\Objects\ProtectorCase\data\expansion_protectorcase_black_co.paa"
		};
	};
};
