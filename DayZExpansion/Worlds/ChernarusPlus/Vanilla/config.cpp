...
class CfgPatches
{
	class DayZExpansion_Worlds_ChernarusPlus
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Data","DZ_Worlds_Chernarusplus_World","DZ_Gear_Navigation"};
		worlds[] = {};
	};
};
class CfgWorlds
...
class RscMapControl
{
	...
	colorTracks[] = {0.2,0.137,0.078,1};
	colorTracksFill[] = {0.2,0.137,0.078,1};
	...
	widthRailWay = 4.0;
	fontLabel = "DayZExpansion/GUI/fonts/etelkatextpro24";
	sizeExLabel = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	fontGrid = "DayZExpansion/GUI/fonts/etelkatextpro24";
	sizeExGrid = 0.02;
	fontUnits = "DayZExpansion/GUI/fonts/etelkatextpro24";
	sizeExUnits = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	fontNames = "DayZExpansion/GUI/fonts/etelkatextpro24";
	sizeExNames = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8) * 2";
	fontInfo = "DayZExpansion/GUI/fonts/etelkatextpro24";
	sizeExInfo = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	fontLevel = "DayZExpansion/GUI/fonts/etelkatextpro24";
	sizeExLevel = 0.02;
