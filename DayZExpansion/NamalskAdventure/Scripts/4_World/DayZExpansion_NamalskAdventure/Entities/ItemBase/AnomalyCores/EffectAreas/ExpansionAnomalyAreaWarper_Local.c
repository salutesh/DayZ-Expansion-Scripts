/**
 * ExpansionAnomalyAreaWarper_Local.c
 *
 * DayZ Expansion Mod
...
class ExpansionAnomalyAreaWarper_Local: ExpansionAnomalyAreaBase_Dynamic
{
	...
	override void SetupZoneData(EffectAreaParams params)
	{
		...
		params.m_ParamPartId 		= ParticleList.EXPANSION_PARTICLE_ANOMALY_AREA_WARPER;
		...
		params.m_ParamTriggerType 	= "ExpansionAnomalyTriggerWarper_Dynamic";
