class CfgPatches
{
	class DayZExpansion_NamalskAdventure_Objects_Lore
	{
		...
		requiredAddons[]=
		{
			...
			"DZ_Structures_Bliss_Underground",
			"ns2_build_a3",
			"DayZExpansion_Objects_Gear_Electricity"
		};
	};
};
class CfgVehicles
{
	...
	class ExpansionFusionCore: Grenade_Base
	{
		...
		{
			"DayZExpansion\NamalskAdventure\Dta\Objects\Lore\data\fusion_core_co.paa",
			"#(argb,8,8,3)color(0,1,1,1.0,CO)"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Objects\Lore\data\Expansion_Fusion_Core.rvmat",
			""
		};
		class DamageSystem
		{
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"nst\ns_dayz\gear\lore\data\lore_paper.rvmat"
							}
						},
						...
						
						{
							...
							{
								"nst\ns_dayz\gear\lore\data\lore_paper_damage.rvmat"
							}
						},
	...
	class NA_Documents_SanctuarySecrets: Inventory_Base
	{
		...
		{
			"Att_ExpansionKeyCardAntenna",
			"Att_ExpansionDokumentBeringOutpost"
		};
		class GUIInventoryAttachmentsProps
		{
	...
	class NA_Documents_ProjectSanctuary: Inventory_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Objects\Lore\data\project_sanctuary.paa"
		};
		inventorySlot[]=
		{
			"Att_ExpansionDokumentBeringOutpost"
	...
	class NA_BeringOutpostNegative: Inventory_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Objects\Lore\data\bering_outpost_negative.paa"
		};
		varWetMax=1;
		class DamageSystem
		{
