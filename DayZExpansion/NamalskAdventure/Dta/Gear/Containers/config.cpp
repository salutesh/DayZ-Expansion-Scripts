...
class CfgPatches
{
	class DayZExpansion_NamalskAdventure_Gear_Containers
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Data","DZ_Characters","DZ_Gear_Containers"};
	};
};
class CfgVehicles
{
	...
	class ExpansionAnomalyCoreProtectiveCase: SmallProtectorCase
	{
		...
		hiddenSelectionsTextures[] = {"\DayZExpansion\NamalskAdventure\Dta\Gear\Containers\data\expansion_anomalycase_gray_co.paa"};
	};
	class ExpansionAnomalyDeconCase: Container_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 1000;
					healthLevels[] = {{1,{"DZ\gear\containers\data\300RoundBox.rvmat"}},{0.7,{"DZ\gear\containers\data\300RoundBox.rvmat"}},{0.5,{"DZ\gear\containers\data\300RoundBox_damage.rvmat"}},{0.3,{"DZ\gear\containers\data\300RoundBox_damage.rvmat"}},{0,{"DZ\gear\containers\data\300RoundBox_destruct.rvmat"}}};
				};
			};
		};
	...
	class Expansion_Halloween_GiftBox_Small: Inventory_Base
	{
		...
		hiddenSelectionsTextures[] = {"\DayZExpansion\NamalskAdventure\Dta\Gear\Containers\data\halloween_1_co.paa","dz\gear\containers\data\christmas_paper_ribbon_CO.paa"};
