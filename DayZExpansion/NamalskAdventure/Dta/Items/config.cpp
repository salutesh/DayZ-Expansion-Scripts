...
class CfgVehicles
{
	...
	class Expansion_AnomalyCore_Base: Grenade_Base
	{
		...
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\anomaly_core_co.paa",
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\anomaly_core_energy_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\Expansion_Anomaly_Core.rvmat",
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\Expansion_Anomaly_Core_Energy.rvmat"
		};
		weight=500;
		itemSize[]={1,1};
		inventorySlot[]=
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\Expansion_Anomaly_Core_Damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\Expansion_Anomaly_Core_Destruct.rvmat"
							}
						}
					};
				};
	...
	class Expansion_AnomalyCore_Fire: Expansion_AnomalyCore_Base
	{
		...
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\anomaly_core_co.paa",
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\anomaly_core_energy_fire_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\Expansion_Anomaly_Core.rvmat",
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\Expansion_Anomaly_Core_Fire_Energy.rvmat"
		};
	};
	class Expansion_AnomalyCore_Ice: Expansion_AnomalyCore_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\anomaly_core_ice_co.paa",
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\anomaly_core_energy_co.paa"
		};
	};
	class Expansion_AnomalyCore_Warper: Expansion_AnomalyCore_Base
	{
		...
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\anomaly_core_co.paa",
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\anomaly_core_energy_warper_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\Expansion_Anomaly_Core.rvmat",
			"DayZExpansion\NamalskAdventure\Dta\Items\Anomaly_Core\data\Expansion_Anomaly_Core_Warper_Energy.rvmat"
		};
	};
	...
	class Expansion_KeyCard_Base: Inventory_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\chip_co.paa",
			"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\keycard_SAT_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\Expansion_Key_Card_Chip.rvmat",
			"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\Expansion_Key_Card.rvmat"
		};
		class DamageSystem
		{
			class GlobalHealth
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\Expansion_Key_Card_Damage.rvmat",
								"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\Expansion_Key_Card_Damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\Expansion_Key_Card_Destruct.rvmat",
								"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\Expansion_Key_Card_Destruct.rvmat"
							}
						}
					};
	...
	class Expansion_KeyCard_Teleporter: Expansion_KeyCard_Base
	{
		...
		{
			"\DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\chip_co.paa",
			"\DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\keycard_TP_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\Expansion_Key_Card_Chip.rvmat",
	...
	class Expansion_KeyCard_A1_B1: Expansion_KeyCard_Base
	{
		...
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\chip_co.paa",
			"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\keycard_B1_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Key_Cards\data\Expansion_Key_Card_Chip.rvmat",
	...
	class Expansion_Key_Base: Inventory_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Keys\data\keys_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Keys\data\Expansion_Keys.rvmat"
		};
		class DamageSystem
		{
			class GlobalHealth
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"DayZExpansion\NamalskAdventure\Dta\Items\Keys\data\Expansion_Keys_Damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"DayZExpansion\NamalskAdventure\Dta\Items\Keys\data\Expansion_Keys_Destruct.rvmat"
							}
						}
					};
				};
	...
	class Expansion_SupplyCrate_WorldT1_Key: Expansion_SupplyCrate_Key_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Keys\data\keys_bw_co.paa"
		};
	};
	class Expansion_Key2_Base: Inventory_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Keys\data\keys_2_co.paa",
			"DayZExpansion\NamalskAdventure\Dta\Items\Keys\data\keys_2_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\NamalskAdventure\Dta\Items\Keys\data\Expansion_Keys.rvmat",
			"DayZExpansion\NamalskAdventure\Dta\Items\Keys\data\Expansion_Keys_Chain.rvmat"
		};
		class DamageSystem
		{
			class GlobalHealth
