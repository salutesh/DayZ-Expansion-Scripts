...
class CfgVehicles
{
	...
	class bldr_plnt_ivy_A: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_A.p3d";
	};
	class bldr_plnt_ivy_B: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_B.p3d";
	};
	class bldr_plnt_ivy_C: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_C.p3d";
	};
	class bldr_plnt_ivy_C2: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_C2.p3d";
	};
	class bldr_plnt_ivy_D: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_D.p3d";
	};
	class bldr_plnt_ivy_dry_A: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_dry_A.p3d";
	};
	class bldr_plnt_ivy_dry_B: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_dry_B.p3d";
	};
	class bldr_plnt_ivy_dry_C: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_dry_C.p3d";
	};
	class bldr_plnt_ivy_dry_D: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_dry_D.p3d";
	};
	class bldr_plnt_ivy_dry_E: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_dry_E.p3d";
	};
	class bldr_plnt_ivy_dry_F: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_dry_F.p3d";
	};
	class bldr_plnt_ivy_dry_G: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\building\ivy_dry_G.p3d";
	};
	class bldr_plnt_ivy_dry_H: HouseNoDestruct
	{
		scope = 1;
	...
	class bldr_plnt_c_GrassSmallConc_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_GrassSmallConc_summer.p3d";
	};
	class bldr_plnt_c_GrassTall2_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_GrassTall2_summer.p3d";
	};
	class bldr_plnt_c_GrassTall3_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_GrassTall3_summer.p3d";
	};
	class bldr_plnt_c_GrassTiny_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_GrassTiny_summer.p3d";
	};
	class bldr_plnt_c_GrassTinyConc_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_GrassTinyConc_summer.p3d";
	};
	class bldr_plnt_c_leaves_dead_half_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_leaves_dead_half_summer.p3d";
	};
	class bldr_plnt_c_leaves_dead_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_leaves_dead_summer.p3d";
	};
	class bldr_plnt_c_Pines_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_Pines_summer.p3d";
	};
	class bldr_plnt_c_plantsSmall1_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_plantsSmall1_summer.p3d";
	};
	class bldr_plnt_c_plantsSmall2_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_plantsSmall2_summer.p3d";
	};
	class bldr_plnt_c_stubble_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_stubble_summer.p3d";
	};
	class bldr_plnt_c_Vaccinium_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_Vaccinium_summer.p3d";
	};
	class bldr_plnt_c_wheat_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_wheat_summer.p3d";
	};
	class bldr_plnt_c_wheat1_summer: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_wheat1_summer.p3d";
	};
	class bldr_plnt_c_wheat2: HouseNoDestruct
	{
		scope = 1;
		model = "DZ\plants_bliss\clutter\c_wheat2.p3d";
	};
	class bldr_plnt_c_wheatTall_summer: HouseNoDestruct
	{
		scope = 1;
