...
class CfgVehicles
{
	...
	class bldr_Decal_asphalt_fix1: HouseNoDestruct
	{
		scope = 1;
		model = "\DZ\structures_bliss\roads\Decals\Decal_asphalt_fix1.p3d";
	};
	class bldr_Decal_asphalt_fix2: HouseNoDestruct
	{
		scope = 1;
		model = "\DZ\structures_bliss\roads\Decals\Decal_asphalt_fix2.p3d";
	};
	class bldr_Decal_asphalt_fix3: HouseNoDestruct
	{
		scope = 1;
	...
	class bldr_Decal_asphalt_fix5: HouseNoDestruct
	{
		scope = 1;
		model = "\DZ\structures_bliss\roads\Decals\Decal_asphalt_fix5.p3d";
	};
	class bldr_Decal_asphalt_fix6: HouseNoDestruct
	{
		scope = 1;
