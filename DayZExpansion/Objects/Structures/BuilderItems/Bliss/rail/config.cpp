...
class CfgPatches
{
	...
	{
		units[] = {"bldr_Rail_Crossing_Block_Small","bldr_Rail_LineBreak_Small","bldr_Rail_TrackSmall_Switch","bldr_Rail_TrackSmall_10m","bldr_Rail_TrackSmall_15deg","bldr_Rail_TrackSmall_20m","bldr_Rail_TrackSmall_30deg","bldr_Rail_TrackSmall_3m","bldr_Rail_TrackSmall_7deg","bldr_Rail_TrackSmall_TurnOutL","bldr_Rail_TrackSmall_TurnOutR"};
		weapons[] = {};
		requiredVersion = 0.1;
