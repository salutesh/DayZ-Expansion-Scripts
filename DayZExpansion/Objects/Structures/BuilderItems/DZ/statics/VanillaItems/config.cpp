...
class CfgVehicles
{
	...
	class bldr_prop_MediumTentPlacing: HouseNoDestruct
	{
		...
		hiddenSelectionsTextures[] = {"dz\gear\camping\data\tent_medium_pitched_b_co.paa"};
	...
	class bldr_prop_LargeTentPlacing: HouseNoDestruct
	{
		scope = 1;
		hiddenSelections[] = {"placing"};
		hiddenSelectionsTextures[] = {"dz\gear\camping\data\large_tent_co.paa"};
	...
	class bldr_prop_CarTentPlacing: HouseNoDestruct
	{
		scope = 1;
		hiddenSelections[] = {"placing"};
		hiddenSelectionsTextures[] = {"dz\gear\camping\data\car_tent_co.paa"};
	...
	class bldr_prop_Apple: HouseNoDestruct
	{
		...
		hiddenSelectionsMaterials[] = {"dz\gear\food\data\apple_raw.rvmat","dz\gear\food\data\apple_baked.rvmat","dz\gear\food\data\apple_boiled.rvmat","dz\gear\food\data\apple_dried.rvmat","dz\gear\food\data\apple_rotten.rvmat","dz\gear\food\data\apple_burnt.rvmat"};
