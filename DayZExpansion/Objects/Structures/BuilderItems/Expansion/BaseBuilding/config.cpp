...
class CfgPatches
{
	...
	{
		units[] = {"bldr_expansion_BarbedWire","bldr_expansion_Hesco","bldr_expansion_HescoKit","bldr_expansion_Helipad","bldr_expansionBarbedWire","bldr_expansion_Gunrack","bldr_expansion_Cone","bldr_expansion_Sign_Danger_01","bldr_expansion_Sign_Danger_02","bldr_expansion_Sign_Danger_03","bldr_expansion_Sign_RoadBarrier","bldr_expansion_Sign_RoadBarrier_LightOn","bldr_expansion_Stove_Closed","bldr_expansion_Stove_Open","bldr_expansion_CamoBox","bldr_expansion_CamoTent","bldr_expansion_Safe_Small_Closed","bldr_expansion_Safe_Small_Opened","bldr_expansion_Safe_Medium_Closed","bldr_expansion_Safe_Medium_Opened","bldr_expansion_Safe_Large_Closed","bldr_expansion_Safe_Large_Opened"};
		weapons[] = {};
		requiredVersion = 0.1;
