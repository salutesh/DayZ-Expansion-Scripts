...
class CfgVehicles
{
	...
	class ExpansionProp_Piano: HouseNoDestruct
	{
		scope = 2;
		model = "\DayZExpansion\Objects\Structures\Props\piano.p3d";
	};
	class ExpansionProp_Piano_chair: HouseNoDestruct
	{
		scope = 2;
		model = "\DayZExpansion\Objects\Structures\Props\piano_chair.p3d";
	};
	class ExpansionPropLogoPlane: HouseNoDestruct
	{
		scope = 2;
		model = "DayZExpansion\Objects\Structures\Props\expansion_logo_plane.p3d";
	};
