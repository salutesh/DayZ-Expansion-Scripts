...
class cfgWeapons
{
	...
	class Expansion_Kar98_Base: BoltActionRifle_InnerMagazine_Base
	{
		...
		{
			"dayzexpansion\objects\weapons\firearms\sniper\kar98\data\kar98_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"dayzexpansion\objects\weapons\firearms\sniper\kar98\data\kar98.rvmat"
		};
		modes[]=
		{
			"SemiAuto"
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"DayZExpansion\Objects\Weapons\Firearms\Sniper\Kar98\data\kar98_Damaged.rvmat"
							}
						},
						...
						
						{
							...
							{
								"DayZExpansion\Objects\Weapons\Firearms\Sniper\Kar98\data\kar98_Ruined.rvmat"
							}
						}
					};
				};
