...
class cfgWeapons
{
	...
	class Expansion_Taser_Base: FNX45_Base
	{
		...
		magazines[] = {"Mag_Expansion_Taser"};
		chamberableFrom[] = {"Expansion_Ammo_Taser"};
		...
		class SemiAuto: Mode_SemiAuto
		{
			...
			soundSetShotExt[] = {{"Shockpistol_Shot_SoundSet","Shockpistol_Tail_SoundSet","Shockpistol_InteriorTail_SoundSet"}};
			reloadTime = 0.086;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 100;
					healthLevels[] = {{1.0,{"DZ\weapons\nonlethal\shockpistol\data\shockpistol_main.rvmat"}},{0.7,{"DZ\weapons\nonlethal\shockpistol\data\shockpistol_main.rvmat"}},{0.5,{"DZ\weapons\nonlethal\shockpistol\data\shockpistol_main_damage.rvmat"}},{0.3,{"DZ\weapons\nonlethal\shockpistol\data\shockpistol_main_damage.rvmat"}},{0.0,{"DZ\weapons\nonlethal\shockpistol\data\shockpistol_main_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
...
class CfgMagazines
{
	...
	class Mag_Expansion_Taser: Mag_FNX45_15Rnd
	{
		...
		count = 2;
		ammo = "Bullet_Expansion_Taser";
		ammoItems[] = {"Expansion_Ammo_Taser"};
		tracersEvery = 0;
		mass = 10;
		class DamageSystem
		{
