	...
	class Mag_Expansion_MP7_40Rnd: Magazine_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 100;
					healthLevels[] = {{1.0,{"DZ\weapons\attachments\data\mp5k_mag.rvmat"}},{0.7,{}},{0.5,{"DZ\weapons\attachments\data\mp5k_mag_damage.rvmat"}},{0.3,{}},{0.0,{"DZ\weapons\attachments\data\mp5k_mag_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
