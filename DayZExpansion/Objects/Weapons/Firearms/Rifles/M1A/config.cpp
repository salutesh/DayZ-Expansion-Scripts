...
class cfgWeapons
{
	...
	class Expansion_M1A: Expansion_M1A_Base
	{
		...
		{
			"DayZExpansion\Objects\Weapons\Firearms\Rifles\M1A\data\dayz_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DayZExpansion\Objects\Weapons\Firearms\Rifles\M1A\data\M1A.rvmat"
		};
		class DamageSystem
		{
			class GlobalHealth
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"DayZExpansion\Objects\Weapons\Firearms\Rifles\M1A\data\M1A_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"DayZExpansion\Objects\Weapons\Firearms\Rifles\M1A\data\M1A_destruct.rvmat"
							}
						}
					};
				};
