...
class CfgVehicles
{
	...
	class ExpansionCodeLock: Inventory_Base
	{
		...
		inventorySlot[]=
		{
			...
			"Att_ExpansionCodeLock_1",
			"Att_ExpansionCodeLock_2",
			"Att_CombinationLock"
		};
		itemSize[]={2,2};
		hiddenSelections[]=
		...
		{
			"\DayZExpansion\Objects\Basebuilding\Items\Codelock\data\codelock_co.paa",
			"\DayZExpansion\Objects\Basebuilding\Items\Codelock\data\codelock_co.paa",
			"\DayZExpansion\Objects\Basebuilding\Items\Codelock\data\codelock_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"\DayZExpansion\Objects\Basebuilding\Items\Codelock\data\codelock.rvmat",
			"\DayZExpansion\Objects\Basebuilding\Items\Codelock\data\codelock.rvmat",
			"\DayZExpansion\Objects\Basebuilding\Items\Codelock\data\codelock.rvmat"
		};
		rotationFlags=17;
	...
	class ExpansionLumberBase: Inventory_Base
	{
		...
		{
			"Att_ExpansionLumber",
			"Att_ExpansionLumber1",
			"Att_ExpansionLumber_2"
		};
		canBeSplit=1;
		varQuantityInit=1;
		varQuantityMin=0;
