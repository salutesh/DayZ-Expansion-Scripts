class CfgPatches
{
	class DayZExpansion_Objects_BaseBuilding_Walls
	{
		...
		requiredAddons[]=
		{
			"DayZExpansion_Objects_BaseBuilding_Data"
		};
	};
};
class CfgVehicles
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"DayZExpansion\Objects\Basebuilding\Data\wood\wood_frame_01_damage_light.rvmat"
							}
						},
