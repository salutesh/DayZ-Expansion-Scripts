	...
	class DZ_Expansion_VirtualContainerStorage
	{
		...
		class defs
		{
			...
			class engineScriptModule
			{
				...
				files[]=
				{
					"DayZExpansion/VirtualContainerStorage/Scripts/Common",
					"DayZExpansion/VirtualContainerStorage/Scripts/1_Core"
				};
			};
			class gameLibScriptModule
			{
				...
				{
					"DayZExpansion/VirtualContainerStorage/Scripts/Common",
					"DayZExpansion/VirtualContainerStorage/Scripts/2_GameLib"
				};
			};
			class gameScriptModule
			{
				...
				{
					"DayZExpansion/VirtualContainerStorage/Scripts/Common",
					"DayZExpansion/VirtualContainerStorage/Scripts/3_Game"
				};
			};
			class worldScriptModule
			{
				...
				{
					"DayZExpansion/VirtualContainerStorage/Scripts/Common",
					"DayZExpansion/VirtualContainerStorage/Scripts/4_World"
				};
			};
			class missionScriptModule
			{
				...
				{
					"DayZExpansion/VirtualContainerStorage/Scripts/Common",
					"DayZExpansion/VirtualContainerStorage/Scripts/5_Mission"
				};
			};
		};
	};
