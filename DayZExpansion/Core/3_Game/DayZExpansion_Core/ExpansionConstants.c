...
//! (currently 1.12 = SaveVersion 119) after release of CF with ModStorage support.
//! Final conversion step will happen after release of next DayZ version (current target 1.13).
static const int EXPANSION_VERSION_GAME_MODSTORAGE_TARGET = 119;
