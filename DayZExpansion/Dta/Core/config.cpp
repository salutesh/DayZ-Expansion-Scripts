...
class CfgPatches
{
	class DayZExpansion_Core
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Vehicles_Wheeled","DZ_Characters","DZ_Scripts","DZ_Data","DZ_AI","DayZExpansion_Animations_Player"};
	};
};
class CfgSurfaces
{
...
class CfgVehicles
{
	...
	{
		attachments[] = {"Head","Shoulder","Melee","Headgear","Mask","Eyewear","Hands","LeftHand","Gloves","Armband","Vest","Body","Back","Hips","Legs","Feet","Book"};
