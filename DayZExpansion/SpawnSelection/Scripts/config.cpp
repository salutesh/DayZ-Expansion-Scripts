	...
	class DZ_Expansion_SpawnSelection
	{
		...
		class defs
		{
			...
			class engineScriptModule
			{
				...
				files[]=
				{
					"DayZExpansion/SpawnSelection/Scripts/Common",
					"DayZExpansion/SpawnSelection/Scripts/1_Core"
				};
			};
			class gameLibScriptModule
			{
				...
				{
					"DayZExpansion/SpawnSelection/Scripts/Common",
					"DayZExpansion/SpawnSelection/Scripts/2_GameLib"
				};
			};
			class gameScriptModule
			{
				...
				{
					"DayZExpansion/SpawnSelection/Scripts/Common",
					"DayZExpansion/SpawnSelection/Scripts/3_Game"
				};
			};
			class worldScriptModule
			{
				...
				{
					"DayZExpansion/SpawnSelection/Scripts/Common",
					"DayZExpansion/SpawnSelection/Scripts/4_World"
				};
			};
			class missionScriptModule
			{
				...
				{
					"DayZExpansion/SpawnSelection/Scripts/Common",
					"DayZExpansion/SpawnSelection/Scripts/5_Mission"
				};
			};
		};
	};
