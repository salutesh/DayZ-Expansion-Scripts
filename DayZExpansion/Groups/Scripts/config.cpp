	...
	class DZ_Expansion_Groups
	{
		...
		class defs
		{
			...
			class engineScriptModule
			{
				...
				files[]=
				{
					"DayZExpansion/Groups/Scripts/Common",
					"DayZExpansion/Groups/Scripts/1_Core"
				};
			};
			class gameLibScriptModule
			{
				...
				{
					"DayZExpansion/Groups/Scripts/Common",
					"DayZExpansion/Groups/Scripts/2_GameLib"
				};
			};
			class gameScriptModule
			{
				...
				{
					"DayZExpansion/Groups/Scripts/Common",
					"DayZExpansion/Groups/Scripts/3_Game"
				};
			};
			class worldScriptModule
			{
				...
				{
					"DayZExpansion/Groups/Scripts/Common",
					"DayZExpansion/Groups/Scripts/4_World"
				};
			};
			class missionScriptModule
			{
				...
				{
					"DayZExpansion/Groups/Scripts/Common",
					"DayZExpansion/Groups/Scripts/5_Mission"
				};
			};
		};
	};
