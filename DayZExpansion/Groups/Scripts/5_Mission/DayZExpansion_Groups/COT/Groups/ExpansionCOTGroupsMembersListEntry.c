...
#ifdef JM_COT
class ExpansionCOTGroupsMembersListEntry: ScriptedWidgetEventHandler
{
	...
	{
		m_Root	= g_Game.GetWorkspace().CreateWidgets("DayZExpansion/Groups/GUI/layouts/COT/groups/Members_List_Entry.layout", parent);
