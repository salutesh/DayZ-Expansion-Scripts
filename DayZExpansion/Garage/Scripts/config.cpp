...
class CfgMods
{
	class DZ_Expansion_Garage
	{
		...
		class defs
		{
			...
			{
				value = "";
				files[] = {"DayZExpansion/Garage/Scripts/Common","DayZExpansion/Garage/Scripts/1_Core"};
			};
			class gameLibScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/Garage/Scripts/Common","DayZExpansion/Garage/Scripts/2_GameLib"};
			};
			class gameScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/Garage/Scripts/Common","DayZExpansion/Garage/Scripts/3_Game"};
			};
			class worldScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/Garage/Scripts/Common","DayZExpansion/Garage/Scripts/4_World"};
			};
			class missionScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/Garage/Scripts/Common","DayZExpansion/Garage/Scripts/5_Mission"};
			};
		};
	};
};
