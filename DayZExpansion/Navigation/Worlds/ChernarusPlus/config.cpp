...
class RscMapControl
{
	...
	colorTracks[]={0.2,0.13699999,0.078000002,1};
	colorTracksFill[]={0.2,0.13699999,0.078000002,1};
	...
	widthRailWay=4;
	fontLabel="DayZExpansion/Core/GUI/fonts/etelkatextpro24";
	sizeExLabel="(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	fontGrid="DayZExpansion/Core/GUI/fonts/etelkatextpro24";
	sizeExGrid=0.02;
	fontUnits="DayZExpansion/Core/GUI/fonts/etelkatextpro24";
	sizeExUnits="(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	fontNames="DayZExpansion/Core/GUI/fonts/etelkatextpro24";
	sizeExNames="(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8) * 2";
	fontInfo="DayZExpansion/Core/GUI/fonts/etelkatextpro24";
	sizeExInfo="(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	fontLevel="DayZExpansion/Core/GUI/fonts/etelkatextpro24";
	sizeExLevel=0.02;
