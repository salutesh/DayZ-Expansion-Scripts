...
class CfgVehicles
{
	...
	class ExpansionATM_Base: ExpansionATMBase
	{
		...
		{
			"dayzexpansion\market\objects\atm\data\expansion_atm.rvmat"
		};
		rotationFlags=12;
	};
	class ExpansionATM_1: ExpansionATM_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"dayzexpansion\market\objects\atm\data\expansion_atm_01_co.paa",
			"dayzexpansion\market\objects\atm\data\expansion_atm_01_co.paa"
		};
	};
	class ExpansionATM_2: ExpansionATM_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"dayzexpansion\market\objects\atm\data\expansion_atm_02_co.paa",
			"dayzexpansion\market\objects\atm\data\expansion_atm_02_co.paa"
		};
	};
	class ExpansionATM_3: ExpansionATM_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"dayzexpansion\market\objects\atm\data\expansion_atm_03_co.paa",
			"dayzexpansion\market\objects\atm\data\expansion_atm_03_co.paa"
		};
	};
