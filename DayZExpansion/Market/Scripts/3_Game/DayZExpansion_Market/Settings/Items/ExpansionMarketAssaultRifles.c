...
class ExpansionMarketAssaultRifles: ExpansionMarketCategory
{
	override void Defaults()
	{
		...
		AddItem("FAL", 					1000,		2000,	1,		100,	{"Fal_OeBttstck","Mag_FAL_20Rnd"});
		...
		AddItem("M4A1", 				1500,		3000,	1,		100,	{"M4_CarryHandleOptic","Mag_STANAG_30Rnd","M4_OEBttstck","M4_PlasticHndgrd"});
		AddItem("M16A2", 				1600,		3200,	1,		100,	{"Mag_STANAG_30Rnd"});
		AddItem("FAMAS", 				1600,		3200,	1,		100,	{"Mag_FAMAS_25Rnd"});
