...
class ExpansionMarketFlags: ExpansionMarketCategory
{
	override void Defaults()
	{
		...
		AddItem("Flag_Chernarus", 					15,		30,		1,		100);
		AddItem("Flag_Chedaki", 					15,		30,		1,		100);
		AddItem("Flag_NAPA", 						15,		30,		1,		100);
		AddItem("Flag_CDF", 						15,		30,		1,		100);
		AddItem("Flag_Livonia", 					15,		30,		1,		100);
		AddItem("Flag_Altis", 						15,		30,		1,		100);
		AddItem("Flag_SSahrani", 					15,		30,		1,		100);
		AddItem("Flag_NSahrani", 					15,		30,		1,		100);
		AddItem("Flag_DayZ", 						15,		30,		1,		100);
		AddItem("Flag_LivoniaArmy", 				15,		30,		1,		100);
		AddItem("Flag_White", 						15,		30,		1,		100);
		AddItem("Flag_Bohemia", 					15,		30,		1,		100);
		AddItem("Flag_APA", 						15,		30,		1,		100);
		AddItem("Flag_UEC", 						15,		30,		1,		100);
		AddItem("Flag_Pirates", 					15,		30,		1,		100);
		AddItem("Flag_Cannibals", 					15,		30,		1,		100);
		AddItem("Flag_Bear", 						15,		30,		1,		100);
		AddItem("Flag_Wolf", 						15,		30,		1,		100);
		AddItem("Flag_BabyDeer", 					15,		30,		1,		100);
		AddItem("Flag_Rooster", 					15,		30,		1,		100);
		AddItem("Flag_LivoniaPolice", 				15,		30,		1,		100);
		AddItem("Flag_CMC", 						15,		30,		1,		100);
		AddItem("Flag_TEC", 						15,		30,		1,		100);
		AddItem("Flag_CHEL", 						15,		30,		1,		100);
		AddItem("Flag_Zenit", 						15,		30,		1,		100);
		AddItem("Flag_HunterZ", 					15,		30,		1,		100);
		AddItem("Flag_BrainZ", 						15,		30,		1,		100);
