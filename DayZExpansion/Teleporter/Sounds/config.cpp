...
class CfgSounds
{
	...
	{
		sound[] = {"DayZExpansion\Teleporter\Sounds\data\teleporter_idle",1,1,30};
	};
};
...
class CfgSoundSets
{
	...
	{
		soundShaders[] = {"Expansion_TeleporterIdle_SoundShader"};
	};
	class Expansion_Teleporter_Active_Soundset: Expansion_Teleporter_Soundset
	{
		soundShaders[] = {"Expansion_TeleporterActive_SoundShader"};
	};
};
